...
public class ModelConverterTest {
     ...
     * Signingframework's API GraphCollection and writes it with Signingframework's API, reads the result with Jena API
     * into Dataset 2, and checks if the specified named graph model from Dataset 1 is isomorphic with the same named
     * graph model from Dataset 2.
     */
     ...
     * Signingframework's API GraphCollection with one NamedGraph, transforms (converts) that NamedGraph into Jena's
     * Model, and checks if the resulting Model is the same as original Model.
     */
