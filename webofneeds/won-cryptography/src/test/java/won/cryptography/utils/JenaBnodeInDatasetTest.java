...
public class JenaBnodeInDatasetTest
{
  ...
  public void testReadWriteDatasetWithTwoGraphs() throws Exception {
    ...
    // Writing in TRIG results in loosing info about shared between graphs blank node.
    // I wrote to Jena mailing list and they opened https://issues.apache.org/jira/browse/JENA-745
  ...
  private void assertSameSubjBnode(Dataset dataset, final String ns,
                                   final String g1,
                                   final String g2,
                                   final String pred1,
                                   final String pred2) {
