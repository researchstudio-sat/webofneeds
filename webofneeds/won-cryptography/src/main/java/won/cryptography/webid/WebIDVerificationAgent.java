...
public class WebIDVerificationAgent {
    ...
    /**
     *
     * @return list of those webIDs that were successfully verified by fetching the webID's url and comparing public key
     *         data found there with the provided in constructor public key data
     */
