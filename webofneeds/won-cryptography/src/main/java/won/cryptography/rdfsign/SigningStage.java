...
/**
 * A helper class to represent the won message information such as which content and envelope graphs are unsigned,
 * signatures unreferenced, envelopes hierarchical order, etc., necessary for the signing component to make decisions on
 * what parts of message should be signed and referenced.
 *
