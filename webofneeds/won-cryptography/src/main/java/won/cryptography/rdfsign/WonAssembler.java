...
public class WonAssembler {
   ...
   * been applied.
   *
   * The method assembles the signature from provided GraphCollection into the
   * origin Dataset by putting signature triples inside the default graph of the
   * Dataset. Intended for the use by WonSigner.
   *
   ...
   *
   * The method assembles the signature from provided GraphCollection into the
   * origin Dataset by putting signature triples inside the named graph of the
   * Dataset. Intended for the use by WonSigner.
   *
   * @param namedSignedGraph GraphCollection containing one named graph with its
   *                         calculated signature
   * @param graphOrigin      Dataset that contains the graph that has was used to
   *                         construct the namedSignedGraph
   * @param sigGraphURI      the name (URI) of the graph that should be assigned
   *                         to the signature graph
   * @throws Exception
   */
