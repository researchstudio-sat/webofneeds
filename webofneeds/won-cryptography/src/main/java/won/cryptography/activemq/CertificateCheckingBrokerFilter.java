...
/**
 * BrokerFilter implementation that authorizes consumers if their TLS certificate digest matches the suffix of the queue
 * name they want to listen to.
 */
public class CertificateCheckingBrokerFilter extends BrokerFilter {
    ...
    /**
     * Owner id is defined as a sha3-224 digest of the owner's certificate , based on the results of comparing the owner
     * id in queue name and the provided certificate fingerprint, the access to read from that queue can be granted or
     * denied.
     * 
     * @param context
     * @param info
