...
public class MatcherProtocolMatcherServiceImpl implements MatcherProtocolMatcherService {
  ...
  @Autowired(required = false) private MatcherProtocolMatcherServiceCallback matcherServiceCallback = new NopMatcherProtocolMatcherServiceCallback();

  //TODO: refactor this to use DataAccessService

  @Override public void onMatcherRegistration(final URI wonNodeUri) {
    logger.debug("matcher registration complete on {} ", wonNodeUri);
    matcherServiceCallback.onRegistered(wonNodeUri);
  }

  @Override public void onNewNeed(final URI wonNodeURI, URI needURI, Dataset content) {
  ...
  @Override public void onNeedActivated(final URI wonNodeURI, final URI needURI) {
  ...
  @Override public void onNeedDeactivated(final URI wonNodeURI, final URI needURI) {
