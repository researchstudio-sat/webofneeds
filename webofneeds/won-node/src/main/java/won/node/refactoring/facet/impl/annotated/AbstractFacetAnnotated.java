 ...
 */
@Component
public abstract class AbstractFacetAnnotated implements FacetCamel
{
 ...
 /* @Autowired
    ...
    //in the con object.
      ...
      if (wonMessage.getReceiverURI() != null) {
        executorService.execute(new Runnable()
        {
          ...
          public void run() {
            try {
             // needFacingConnectionClient.open(wonMessage);
            } catch (Exception e) {
  ...
  public void closeFromOwner(final Connection con, final Model content, final WonMessage wonMessage)
    ...
    if (con.getRemoteConnectionURI() != null) {
      executorService.execute(new Runnable()
      {
        ...
        {
          try {
            //  needFacingConnectionClient.close(wonMessage);
          } catch (Exception e) {
  ...
  public void sendMessageFromOwner(final Connection con, final Model message, final WonMessage wonMessage)
    ...
    executorService.execute(new Runnable() {
      ...
      public void run() {
        try {
        //    needFacingConnectionClient.sendMessage(wonMessage);
        } catch (Exception e) {
