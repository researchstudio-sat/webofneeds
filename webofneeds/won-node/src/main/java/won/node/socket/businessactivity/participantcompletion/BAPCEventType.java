...
public enum BAPCEventType {
    ...
    ///
    MESSAGE_CANCEL("MessageCancel", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_CLOSE("MessageClose", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_COMPENSATE("MessageCompensate",
                    new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING, BAPCState.COMPLETED,
                                    BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING,
                                    BAPCState.ENDED))),
    MESSAGE_FAILED("MessageFailed", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_EXITED("MessageExited", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_NOTCOMPLETED("MessageNotCompleted",
                    new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING, BAPCState.COMPLETED,
                                    ...
                                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING,
                                    BAPCState.ENDED))),
    MESSAGE_EXIT("MessageExit", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_COMPLETED("MessageCompleted", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_FAIL("MessageFail", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_CANNOTCOMPLETE("MessageCanNotComplete",
                    new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING, BAPCState.COMPLETED,
                                    ...
                                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING,
                                    BAPCState.ENDED))),
    MESSAGE_CANCELED("MessageCanceled", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    MESSAGE_CLOSED("MessageClosed", new ArrayList<BAPCState>(Arrays.asList(BAPCState.ACTIVE, BAPCState.CANCELING,
                    BAPCState.COMPLETED, BAPCState.CLOSING, BAPCState.COMPENSATING, BAPCState.FAILING_ACTIVE_CANCELING,
                    BAPCState.FAILING_COMPENSATING, BAPCState.NOT_COMPLETING, BAPCState.EXITING, BAPCState.ENDED))),
    ...
    public static BAPCEventType getCoordinationEventTypeFromURI(final String fragment) {
        ...
        for (BAPCEventType event : BAPCEventType.values())
            if (event.name().equals("MESSAGE_" + fragment
                            .substring(fragment.lastIndexOf("#Message") + 8, fragment.length()).toUpperCase()))
                return event;
        return null;
    }
    ...
    public static boolean isBAPCParticipantEventType(final BAPCEventType event) {
        ...
        if (event.equals(BAPCEventType.MESSAGE_COMPLETED) || event.equals(BAPCEventType.MESSAGE_EXIT)
                        || event.equals(BAPCEventType.MESSAGE_FAIL)
                        || event.equals(BAPCEventType.MESSAGE_CANNOTCOMPLETE)
                        || event.equals(BAPCEventType.MESSAGE_CANCELED)
                        || event.equals(BAPCEventType.MESSAGE_COMPENSATED)
