package won.node.socket.businessactivity.coordinatorcompletion;
...
public enum BACCEventType {
    ...
    ///
    MESSAGE_CANCEL("MessageCancel", new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED, BACCState.CLOSING,
                    BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
                    BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_CLOSE("MessageClose", new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED, BACCState.CLOSING,
                    BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
                    BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_COMPENSATE("MessageCompensate",
                    new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED,
    ...
    MESSAGE_FAILED("MessageFailed", new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED, BACCState.CLOSING,
                    BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
                    BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_EXITED("MessageExited", new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED, BACCState.CLOSING,
                    BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
                    BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_NOTCOMPLETED("MessageNotCompleted",
                    new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                                    ...
                                    BACCState.FAILING_ACTIVE_CANCELING_COMPLETING, BACCState.FAILING_COMPENSATING,
                                    BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_EXIT("MessageExit", new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED, BACCState.CLOSING,
                    BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
                    BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_COMPLETED("MessageCompleted",
                    new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                                    ...
                                    BACCState.FAILING_ACTIVE_CANCELING_COMPLETING, BACCState.FAILING_COMPENSATING,
                                    BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_FAIL("MessageFail", new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED, BACCState.CLOSING,
                    BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
                    BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    ...
    MESSAGE_CANCELED("MessageCanceled",
                    new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                                    ...
                                    BACCState.FAILING_ACTIVE_CANCELING_COMPLETING, BACCState.FAILING_COMPENSATING,
                                    BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    MESSAGE_CLOSED("MessageClosed", new ArrayList<BACCState>(Arrays.asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE,
                    BACCState.CANCELING_COMPLETING, BACCState.COMPLETING, BACCState.COMPLETED, BACCState.CLOSING,
                    BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
                    BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),
    ...
    public static boolean isBACCParticipantEventType(final BACCEventType event) {
        ...
        if (event.equals(BACCEventType.MESSAGE_COMPLETED) || event.equals(BACCEventType.MESSAGE_EXIT)
                        || event.equals(BACCEventType.MESSAGE_FAIL)
                        || event.equals(BACCEventType.MESSAGE_CANNOTCOMPLETE)
                        || event.equals(BACCEventType.MESSAGE_CANCELED)
                        || event.equals(BACCEventType.MESSAGE_COMPENSATED)
