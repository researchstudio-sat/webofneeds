...
public class NeedProtocolOutgoingMessagesProcessor implements Processor {
  ...
  @Autowired private NeedProtocolCommunicationService needProtocolCommunicationService;
  ...
  @Override public void process(Exchange exchange) throws Exception {
    ...
    if (wonMessage.getSenderNeedURI() != null && wonMessage.getSenderNodeURI()
        .equals(wonMessage.getReceiverNodeURI())) {
