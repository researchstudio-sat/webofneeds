 ...
 *
 */
@Component @FixedMessageReactionProcessor(direction = WONMSG.TYPE_FROM_SYSTEM_STRING, messageType = WONMSG.TYPE_DEACTIVATE_STRING) public class DeactivateNeedMessageFromSystemReactionProcessor
  ...
  public void closeConnection(final Need need, final Connection con) {
    ...
    WonMessage message = WonMessageBuilder
        .setMessagePropertiesForClose(messageURI, WonMessageDirection.FROM_SYSTEM, con.getConnectionURI(),
            ...
            "Closed because Need was deactivated").build();
