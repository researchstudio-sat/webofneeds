...
@FacetMessageProcessor(facetType = WON.CHAT_FACET_STRING, direction = WONMSG.TYPE_FROM_OWNER_STRING, messageType = WONMSG.TYPE_CLOSE_STRING)
public class CloseFromOwnerChatFacetImpl extends AbstractCamelProcessor {
    @Override
