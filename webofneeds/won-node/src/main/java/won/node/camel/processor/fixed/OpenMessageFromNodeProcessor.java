        ...
        if (!connectionURIFromWonMessage.isPresent()) {
            ...
            if (!facetURI.isPresent())
                throw new IllegalArgumentException(
                                "Cannot process OPEN FROM_EXTERNAl as no facet information is present");
            ...
            if (!con.isPresent()) {
                ...
                con = Optional.of(dataService.createConnection(connectionUri, wonMessage.getReceiverNeedURI(),
                                wonMessage.getSenderNeedURI(), wonMessage.getSenderURI(), facet.getFacetURI(),
                                facet.getTypeURI(), remoteFacetURI.get(), ConnectionState.REQUEST_RECEIVED,
