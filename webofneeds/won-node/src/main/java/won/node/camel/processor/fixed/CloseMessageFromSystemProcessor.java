...
/**
 * Processes a CLOSE message coming from the FROM_SYSTEM direction. The effects are:
 * <ul>
...
public class CloseMessageFromSystemProcessor extends AbstractCamelProcessor {
    ...
    public void process(final Exchange exchange) throws Exception {
        ...
        if (con.getRemoteConnectionURI() != null) {
            ...
            // put the factory into the outbound message factory header. It will be used to generate the outbound
            // message
