...
@Component @FixedMessageProcessor(
    ...
    messageType = WONMSG.TYPE_CONNECT_STRING) public class ConnectMessageFromNodeProcessor
  ...
  public void process(final Exchange exchange) throws Exception {
    ...
    if (connectionURI != null) {
      ...
      if (conOpt.isPresent()) {
        ...
        conOpt = connectionRepository
            .findOneByNeedURIAndRemoteNeedURIAndFacetURIAndNullRemoteFacetForUpdate(needUri, remoteNeedUri,
                facet.getFacetURI());
        if (conOpt.isPresent()) {
    ...
    if (con == null) {
      ...
      con = dataService
          .createConnection(connectionUri, needUri, remoteNeedUri, remoteConnectionUri, facet.getFacetURI(),
              facet.getTypeURI(), remoteFacetURI, ConnectionState.REQUEST_RECEIVED, ConnectionEventType.PARTNER_OPEN);
    }
