...
public class ConnectMessageFromNodeProcessor extends AbstractCamelProcessor {
  ...
  public void process(final Exchange exchange) throws Exception {
    ...
    // we complain about hasFacet, not hasRemoteFacet, because it's a remote
    // message!
    ...
    if (connectionURI != null) {
      ...
      if (conOpt.isPresent()) {
        ...
        conOpt = connectionRepository.findOneByNeedURIAndRemoteNeedURIAndFacetURIAndNullRemoteFacetForUpdate(needUri,
            remoteNeedUri, facet.getFacetURI());
        if (conOpt.isPresent()) {
