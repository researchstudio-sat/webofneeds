 ...
 */
@Component
@FixedMessageProcessor(direction = WONMSG.FromSystemString, messageType = WONMSG.ConnectMessageString)
public class ConnectMessageFromSystemProcessor extends AbstractCamelProcessor {
