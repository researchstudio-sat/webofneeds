...
/**
 * Simple helper class that creates a ConnectionStateChange object in two steps: First, set the old state (or none if
 * there is no connection yet), second set the new state.
 */
