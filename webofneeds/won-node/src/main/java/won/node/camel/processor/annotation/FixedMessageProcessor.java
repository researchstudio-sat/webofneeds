...
/**
 * Identifies the annotated class as a message processor used to implement the obligatory behavior for the specified
 ...
 * messages are sent before the current message has been processed completely. If new messages are to be sent, this is
 * to be done in a FixedMessageReactionProcessor.
 *
