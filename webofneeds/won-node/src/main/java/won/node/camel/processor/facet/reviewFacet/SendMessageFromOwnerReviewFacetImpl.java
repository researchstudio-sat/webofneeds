...
@FacetMessageProcessor(facetType = WON.REVIEW_FACET_STRING,direction=WONMSG.TYPE_FROM_OWNER_STRING,messageType =
  WONMSG.TYPE_CONNECTION_MESSAGE_STRING)
public class SendMessageFromOwnerReviewFacetImpl extends AbstractFromOwnerCamelProcessor
{
  @Override
