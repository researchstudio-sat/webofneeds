...
public class WonMessageRoutes extends RouteBuilder {
  ...
  public void configure() throws Exception {
    onException(CannotAcquireLockException.class, JpaSystemException.class) // due to our transaction isolation, we may
                                                                            // have to retry
    ...
    from("activemq:queue:MatcherProtocol.in?concurrentConsumers=5").transacted("PROPAGATION_NEVER")
        ...
        .to("bean:directionFromExternalAdder").to("bean:receivedTimestampAdder").to("direct:processHintAndStore")
        .to("bean:toOwnerSender") // --> seda:OwnerProtocolOut
