...
public class OpenMessageFromSystemProcessor extends AbstractFromOwnerCamelProcessor
{
    ...
    public void process(Exchange exchange) throws Exception {
        logger.info("processing OPEN message from system for {} as if it was sent from owner", ((WonMessage) exchange.getIn().getHeader(WonCamelConstants.MESSAGE_HEADER)).getSenderURI());
