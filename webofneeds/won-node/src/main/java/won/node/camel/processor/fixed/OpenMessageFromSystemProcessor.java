...
/**
 * Required for auto-open facets. Delegates the processing method to the OpenMessageFromOwnerProcessor.
 */
@Component @FixedMessageProcessor(direction = WONMSG.TYPE_FROM_SYSTEM_STRING, messageType = WONMSG.TYPE_OPEN_STRING) public class OpenMessageFromSystemProcessor
    extends AbstractFromOwnerCamelProcessor {
  private final Logger logger = LoggerFactory.getLogger(getClass());

  @Autowired private OpenMessageFromOwnerProcessor openFromOwnerProcessor;
