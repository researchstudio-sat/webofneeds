...
/**
 * Processor that expects an outgoingMessageFactory in the respecitve in header, uses it to generate the outgoing
 * message and places the new message in the WonOutgoingMessage header
 */
