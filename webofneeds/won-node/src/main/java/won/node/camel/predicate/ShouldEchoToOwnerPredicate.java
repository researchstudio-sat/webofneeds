...
/**
 * True if the WonMessage in the wonOriginalMessage header meets the criteria for echoing it to the owner: - sent
 * FROM_SYSTEM or FROM_OWNER - if it is a response, it is not directed at the remote need
 */
