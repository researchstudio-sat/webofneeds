 ...
 * Date: 02.03.2015
 */
@Component @FixedMessageProcessor(direction = WONMSG.TYPE_FROM_OWNER_STRING, messageType = WONMSG.TYPE_DEACTIVATE_STRING) public class DeactivateNeedMessageProcessor
