...
@FacetMessageProcessor(facetType = WON.CHAT_FACET_STRING, direction = WONMSG.TYPE_FROM_EXTERNAL_STRING, messageType = WONMSG.TYPE_CHANGE_NOTIFICATION_STRING)
public class SendChangeNotificationMessageFromNodeChatFacetImpl extends AbstractCamelProcessor {
    @Override
