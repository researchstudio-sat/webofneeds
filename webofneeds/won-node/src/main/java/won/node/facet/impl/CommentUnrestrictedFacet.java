...
public class CommentUnrestrictedFacet extends AbstractFacet {
    ...
    public void connectFromNeed(Connection con, Model content, WonMessage wonMessage)
        ...
        try {
            ...
            needContent.add(needContent.createStatement(needContent.getResource(con.getNeedURI().toString()),
                    SIOC.HAS_REPLY, needContent.getResource(con.getRemoteNeedURI().toString())));
