...
/**
 * Created with IntelliJ IDEA. User: Danijel Date: 16.1.14. Time: 16.30 To change this template use File | Settings |
 * File Templates.
 */
                ...
                try {
                    ...
                    if (messageForSending != null) {
                        ...
                        logger.debug("*** Participant sends the text message:" + eventType + " coordinator:"
                                + con.getRemoteNeedURI() + " participant:" + con.getNeedURI() + " con:"
                    ...
                    if ((eventType != null)) {
                        if (eventType.isBAPCParticipantEventType(eventType)) {
                            ...
                            logger.debug("New state = coordinator:" + con.getRemoteNeedURI() + " participant:"
                                    + con.getNeedURI() + " con:" + con.getConnectionURI() + " baState:"
                                    + stateManager.getStateForNeedUri(con.getNeedURI(), con.getRemoteNeedURI(),
                                            getFacetType().getURI()).toString());
            ...
            public void run() {
                try {
                    ...
                    logger.debug("*** Participant receives a message:" + message.toString() + " coordinator:"
                            + con.getRemoteNeedURI() + " participant:" + con.getNeedURI() + " con:"
                            + con.getConnectionURI() + " baState:" + stateManager.getStateForNeedUri(con.getNeedURI(),
                                    con.getRemoteNeedURI(), getFacetType().getURI()).toString());
                    ...
                    if (resendEventType != null) {
                        ...
                        if (BAPCEventType.isBAPCParticipantEventType(resendEventType)) {
                            ...
                            logger.info("New state of the Participant:" + stateManager.getStateForNeedUri(
