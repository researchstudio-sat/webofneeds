      ...
      @Override public void run() {
        try {
          ...
          if (messageForSending != null) {
            ...
            logger.debug(
                "*** Participant sends the text message:" + eventType + " coordinator:" + con.getRemoteNeedURI()
                    + " participant:" + con.getNeedURI() +
          ...
          // message as MODEL
            ...
            if (ni.hasNext()) {
              ...
              logger.debug("*** Participant sends the RDF message:" + eventType.getURI() + " coordinator:" + con
                  .getRemoteNeedURI() + " participant:" + con.getNeedURI() +
                  " con:" + con.getConnectionURI() + " baState:" + stateManager
                  .getStateForNeedUri(con.getNeedURI(), con.getRemoteNeedURI(), getFacetType().getURI()).toString());
            }
          }
    ...
    executorService.execute(new Runnable() {
      @Override public void run() {
        try {
          ...
          logger.debug(
              "*** Participant receives a message:" + message.toString() + " coordinator:" + con.getRemoteNeedURI()
                  + " participant:" + con.getNeedURI() +
                  " con:" + con.getConnectionURI() + " baState:" + stateManager
                  .getStateForNeedUri(con.getNeedURI(), con.getRemoteNeedURI(), getFacetType().getURI()).toString());
          ...
          if (resendEventType != null) {
            ...
            if (BAPCEventType.isBAPCParticipantEventType(resendEventType)) {
              ...
              logger.info("New state of the Participant:" + stateManager
