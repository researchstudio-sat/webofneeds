...
/**
 * Created with IntelliJ IDEA. User: Danijel Date: 9.12.13. Time: 19.19 To change this template use File | Settings |
 * File Templates.
 */
public class ParticipantFacetImpl extends AbstractFacet {
    ...
    public void compensate(Connection con, Model content) { // todo
        // TODO: create utilities for accessing addtional content
        /*
         * Resource res = content.getResource(content.getNsPrefixURI("")); if (res == null) { logger.
         * debug("no default prexif specified in model, could not obtain additional content, using ABORTED message"); }
         * res.removeAll(WON_TX.COORDINATION_MESSAGE); res.addProperty(WON_TX.COORDINATION_MESSAGE,
    ...
    public void connectFromOwner(final Connection con, final Model content, final WonMessage wonMessage)
        ...
        // TODO: This should just remove RemoteFacet from content and replace the value of Facet with the one from
        // RemoteFacet
