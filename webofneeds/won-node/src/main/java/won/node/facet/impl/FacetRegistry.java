...
/**
 * Created with IntelliJ IDEA. User: gabriel Date: 16.09.13 Time: 18:43 To change this template use File | Settings |
 * File Templates.
 */
public class FacetRegistry {
    ...
    public FacetLogic get(URI connectionURI) throws NoSuchConnectionException {
        return get(FacetType
                .getFacetType(DataAccessUtils.loadConnection(connectionRepository, connectionURI).getTypeURI()));
    }
