...
public enum BACCEventType {
  ...
  ///
  MESSAGE_CANCEL("MessageCancel", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_CLOSE("MessageClose", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_COMPENSATE("MessageCompensate", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_FAILED("MessageFailed", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_EXITED("MessageExited", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_NOTCOMPLETED("MessageNotCompleted", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_EXIT("MessageExit", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_COMPLETED("MessageCompleted", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_FAIL("MessageFail", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_CANNOTCOMPLETE("MessageCanNotComplete", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_CANCELED("MessageCanceled", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_CLOSED("MessageClosed", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_COMPENSATED("MessageCompensated", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED))),

  MESSAGE_COMPLETE("MessageComplete", new ArrayList<BACCState>(Arrays
      .asList(BACCState.ACTIVE, BACCState.CANCELING_ACTIVE, BACCState.CANCELING_COMPLETING, BACCState.COMPLETING,
          BACCState.COMPLETED, BACCState.CLOSING, BACCState.COMPENSATING, BACCState.FAILING_ACTIVE_CANCELING_COMPLETING,
          BACCState.FAILING_COMPENSATING, BACCState.NOT_COMPLETING, BACCState.EXITING, BACCState.ENDED)));
  ...
  public static boolean isBACCParticipantEventType(final BACCEventType event) {
    boolean ret = false;
    if (event.equals(BACCEventType.MESSAGE_COMPLETED) || event.equals(BACCEventType.MESSAGE_EXIT) || event
        .equals(BACCEventType.MESSAGE_FAIL) || event.equals(BACCEventType.MESSAGE_CANNOTCOMPLETE) || event
        .equals(BACCEventType.MESSAGE_CANCELED) || event.equals(BACCEventType.MESSAGE_COMPENSATED) || event
        .equals(BACCEventType.MESSAGE_CLOSED))
      ret = true;
    return ret;
  }
