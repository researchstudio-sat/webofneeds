...
public class URIService implements InitializingBean {
    ...
    /**
     * Transforms the specified URI, which may be a resource URI or a page URI, to a data URI. If the specified URI
     * doesn't start with the right prefix, it's returned unchanged.
     * 
    ...
    /**
     * Transforms the specified URI, which may be a resource URI or a page URI, to a page URI. If the specified URI
     * doesn't start with the right prefix, it's returned unchanged.
     * 
