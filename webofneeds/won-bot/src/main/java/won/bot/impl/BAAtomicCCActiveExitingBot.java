...
import won.bot.framework.events.listener.baStateBots.baCCMessagingBots.atomicBots.activeBots.coordinationMessageAsTextBot.ActiveExitVoteFPBot;
import won.bot.framework.events.listener.baStateBots.baCCMessagingBots.atomicBots.activeBots.coordinationMessageAsTextBot.ActiveExitVoteSPBot;
import won.bot.framework.events.listener.baStateBots.baCCMessagingBots.atomicBots.activeBots.coordinationMessageAsTextBot.CompletingFPBot;
import won.bot.framework.events.listener.baStateBots.baCCMessagingBots.atomicBots.activeBots.coordinationMessageAsTextBot.CompletingSPCancelingBot;
...
public abstract class BAAtomicCCActiveExitingBot extends BAAtomicCCBaseBot{
  ...
  protected List<BATestBotScript> getFirstPhaseScripts() {
    ...
    scripts.add(new ActiveExitVoteFPBot());
