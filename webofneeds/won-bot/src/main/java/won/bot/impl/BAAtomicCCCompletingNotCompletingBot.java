...
import won.bot.framework.eventbot.listener.baStateBots.baCCMessagingBots.atomicBots.coordinationMessageAsTextBot.CompletingCannotCompleteVoteSPBot;
 ...
 */
public class BAAtomicCCCompletingNotCompletingBot extends BAAtomicBaseBot {
    @Override
    ...
    protected List<BATestBotScript> getSecondPhaseScripts() {
        ...
        scripts.add(new CompletingCannotCompleteVoteSPBot());
