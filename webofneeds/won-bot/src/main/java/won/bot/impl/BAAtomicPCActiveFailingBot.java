...
import won.bot.framework.eventbot.listener.baStateBots.baPCMessagingBots.atomicBots.coordinationMessageAsTextBot.ActiveFailVoteSPBot;
 ...
 * Date: 24.4.14.
 */
public class BAAtomicPCActiveFailingBot extends BAAtomicBaseBot
{
  @Override
