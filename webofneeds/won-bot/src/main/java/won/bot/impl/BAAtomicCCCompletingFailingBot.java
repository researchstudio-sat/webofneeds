...
import won.bot.framework.eventbot.listener.baStateBots.baCCMessagingBots.atomicBots.coordinationMessageAsTextBot.CompletingFailinglVoteSPBot;
 ...
 */
public class BAAtomicCCCompletingFailingBot extends BAAtomicBaseBot {
    @Override
    ...
    protected List<BATestBotScript> getSecondPhaseScripts() {
        ...
        scripts.add(new CompletingFailinglVoteSPBot());
