...
public class AnalyzeBehaviour extends BotBehaviour {
    ...
    private class AnalyzeAction extends BaseEventBotAction {
        ...
        protected void doRun(Event event, EventListener executingListener) throws Exception {
            ...
            AgreementProtocolState agreementProtocolState = AgreementProtocolState.of(connectionUri,
                    getEventListenerContext().getLinkedDataSource()); // Initialize with null, to ensure some form of
                                                                      // lazy init for the agreementProtocolState
            ...
            messageEffects.forEach(messageEffect -> {
                    ...
                    if (!proposalModel.isEmpty()) {
                        ...
                        for (Resource goal : goalsInNeed) {
                            ...
                            if (!AnalyzeBehaviour.this.hasPreconditionProposalRelation(preconditionUri,
                                ...
                                // TODO: WE MIGHT NEED TO CHECK WHETHER THE PRECONDITION IS ACTUALLY FULFILLED OR NOT
                                // BEFORE WE REMOVE THE TEMP STATUS
                ...
                case REJECTS:
                    ...
                    logger.trace(
                            "\t\tremove Proposal References for: " + messageEffect.asRejects().getRejectedMessageUri());
            ...
            for (Resource goal : goalsInNeed) {
                ...
                if (AnalyzeBehaviour.this.isPreconditionMetInProposals(preconditionUri)) {
                    ...
                    // conversationDataset = WonConversationUtils.getAgreementProtocolState(connectionUri,
                    // linkedDataSource).getConversationDataset(); //TODO: I DONT KNOW WHY THIS CHANGE HAPPENED
    ...
    /**
     * Removes the stored state of a given Precondition, in order to reset that there was ever a state present for the
     * precondition
     * 
     * @param preconditionURI
     */
    ...
    /**
     * Removes the stored entry for a preconditionPending Uri This method is used so we can remove the pending
     * precondition (e.g if a proposal can't be created)
     * 
     * @param preconditionPendingURI
     *            the string of the preconditionUri that is not pending anymore
     */
     ...
     * 
     * @param preconditionURI
     *            the string of the preconditionUri
     */
    ...
    public boolean hasPreconditionConnectionRelation(String connectionURI, String preconditionURI) {
        Precondition precondition = new Precondition(preconditionURI, false); // Status of the Precondition is
                                                                              // irrelevant (equals works on uri alone)
     ...
     * 
     * @param proposalURI
     *            string of the proposaluri to retrieve the preconditionList of
    ...
    /**
     * @param preconditionURI
     *            string of the uri of the precondition
    ...
    /**
     * @param proposalUri
     *            uri of the proposal to retrieve the preconditionList of
     ...
     * 
     * @param proposalURI
     *            the string of the proposalURI to be removed
     */
