...
/**
 * BaseEventBotAction connecting two needs on the specified facets or on their default facets. Requires a
 * NeedSpecificEvent to run and expeects the needURI from the event to be associated with another need URI via the
