...
/**
 * Created with IntelliJ IDEA. User: Danijel Date: 6.3.14. Time: 12.12 To change this template use File | Settings |
 * File Templates.
 */
public class BACCStateCompleteFailBot extends BATestBotScript {
