 ...
 * worked.
 * <p>
 * The optional constructor parameter <code>messageIsSentToRemoteNode</code>,
 * which defaults to true is used to determine if response listeners for a
 * response from the remote node are to be registered
 */
