 ...
 * named list.
 */
public class AtomUriInNamedListFilter extends AbstractNamedUriListFilter {
    public AtomUriInNamedListFilter(final EventListenerContext context, final String listname) {
