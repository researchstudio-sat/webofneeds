 ...
 * Date: 17.4.14.
 */
public class ActiveFailingVoteFPUriBot extends BATestBotScript
{
  ...
  protected List<BATestScriptAction> setupActions() {
    ...
    actions.add(new NopAction());
    actions.add(new BATestScriptAction(true, URI.create(WON_BA.MESSAGE_FAIL.getURI()), URI.create(WON_BA.STATE_ACTIVE.getURI())));
