...
//        actions.add(new BATestScriptAction(true, "MESSAGE_CANCEL", URI.create(WON_BA.STATE_ACTIVE.getURI())));  //Message can not be sent from Participant, only from Coordinator
//        actions.add(new BATestScriptAction(false, "MESSAGE_CANCEL", URI.create(WON_BA.STATE_ACTIVE.getURI())));  //Message can not be sent from Participant, only from Coordinator
//        actions.add(new BATestScriptAction(false, "MESSAGE_EXITED", URI.create(WON_BA.STATE_ACTIVE.getURI())));  //Message can be sent from Coordinator, but not from this state
//        actions.add(new BATestScriptAction(false, "MESSAGE_COMPLETED", URI.create(WON_BA.STATE_ACTIVE.getURI())));
//        actions.add(new BATestScriptAction(true, "MESSAGE_COMPLETED", URI.create(WON_BA.STATE_ACTIVE.getURI())));
