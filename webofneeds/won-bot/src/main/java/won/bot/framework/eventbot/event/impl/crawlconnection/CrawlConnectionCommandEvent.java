 ...
 */
public class CrawlConnectionCommandEvent extends BaseAtomSpecificEvent implements CommandEvent {
    private URI connectionURI;

    public CrawlConnectionCommandEvent(URI atomURI, URI connectionURI) {
        super(atomURI);
