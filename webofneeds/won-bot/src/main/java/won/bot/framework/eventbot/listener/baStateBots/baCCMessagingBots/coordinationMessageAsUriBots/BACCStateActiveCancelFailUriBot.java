...
/**
 * Created with IntelliJ IDEA. User: Danijel Date: 6.3.14. Time: 12.53 To change this template use File | Settings |
 * File Templates.
 */
public class BACCStateActiveCancelFailUriBot extends BATestBotScript {
    ...
    protected List<BATestScriptAction> setupActions() {
        ...
        actions.add(new BATestScriptAction(true, URI.create(WON_TX.MESSAGE_FAIL.getURI()),
                URI.create(WON_TX.STATE_CANCELING_ACTIVE.getURI())));
