...
import won.bot.framework.events.event.impl.debugbot.SetChattinessDebugCommandEvent;

import java.net.URI;
import java.util.HashSet;
import java.util.Set;

import static won.bot.framework.events.action.impl.debugbot.SendChattyMessageAction.KEY_CHATTY_CONNECTIONS;
