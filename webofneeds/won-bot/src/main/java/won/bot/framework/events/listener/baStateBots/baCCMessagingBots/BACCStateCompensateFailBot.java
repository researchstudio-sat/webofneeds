...
public class BACCStateCompensateFailBot extends BATestBotScript {
    ...
    protected List<BATestScriptAction> setupActions() {
        ...
        actions.add(new BATestScriptAction(false, "MESSAGE_COMPENSATE", URI.create(WON_BACC.STATE_COMPLETED.getURI())));
        actions.add(new BATestScriptAction(true, "MESSAGE_FAIL", URI.create(WON_BACC.STATE_COMPENSATING.getURI())));
        actions.add(new BATestScriptAction(false, "MESSAGE_FAILED", URI.create(WON_BACC.STATE_FAILING_COMPENSATING.getURI())));
        return actions;
    }
}
