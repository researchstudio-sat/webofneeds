...
public class CreateNeedWithFacetsAction extends BaseEventBotAction
{
    ...
    protected void doRun(Event event) throws Exception
    {
        ...
        final ListenableFuture<URI> futureNeedUri = getEventListenerContext().getOwnerService().createNeed(URI.create("we://dont.need.this/anymore"), needModel, true, wonNodeUri, null);
