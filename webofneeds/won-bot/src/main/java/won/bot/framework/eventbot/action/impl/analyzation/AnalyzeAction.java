    ...
    protected void doRun(Event event, EventListener executingListener) throws Exception {
        ...
        if(event instanceof WonMessageReceivedOnConnectionEvent){
            ...
            if(WonRdfUtils.MessageUtils.isAccepts(receivedOnConnectionEvent.getWonMessage())){
                ...
                Model agreementPayload = HighlevelProtocols.getAgreement(fullConversationDataset, receivedOnConnectionEvent.getWonMessage().getCorrespondingRemoteMessageURI());
