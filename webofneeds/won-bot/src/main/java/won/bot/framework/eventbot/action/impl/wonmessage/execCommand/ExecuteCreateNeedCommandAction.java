    ...
    protected void doRun(Event event, EventListener executingListener) throws Exception {
        ...
        if (needDataset == null) {
            ...
            getEventListenerContext().getEventBus()
                    .publish(new NeedCreationAbortedEvent(null, null, createNeedCommandEvent,
        ...
        EventListener successCallback = new EventListener() {
            ...
            public void onEvent(Event event) throws Exception {
                ...
                getEventListenerContext().getEventBus().publish(
                        new CreateNeedCommandSuccessEvent(needURI, needUriBeforeCreation, createNeedCommandEvent));
