...
public class ExecuteCreateNeedCommandAction extends BaseEventBotAction {
    ...
    protected void doRun(Event event, EventListener executingListener) throws Exception {
        ...
        if (needDataset == null) {
            ...
            getEventListenerContext().getEventBus().publish(new NeedCreationAbortedEvent(null, null,
        ...
        WonMessage createNeedMessage = createWonMessage(wonNodeInformationService, needURI, wonNodeUri,
                        needDatasetWithFacets, createNeedCommandEvent.isUsedForTesting(),
                        createNeedCommandEvent.isDoNotMatch());
        ...
        EventListener successCallback = new EventListener() {
            ...
            public void onEvent(Event event) throws Exception {
                ...
                getEventListenerContext().getEventBus().publish(new CreateNeedCommandSuccessEvent(needURI,
                                needUriBeforeCreation, createNeedCommandEvent));
            }
        };
        EventListener failureCallback = new EventListener() {
            ...
            public void onEvent(Event event) throws Exception {
                ...
                getEventListenerContext().getEventBus().publish(new CreateNeedCommandFailureEvent(needURI,
                                needUriBeforeCreation, createNeedCommandEvent, textMessage));
                EventBotActionUtils.removeFromList(getEventListenerContext(), needURI,
                                createNeedCommandEvent.getUriListName());
            }
        };
