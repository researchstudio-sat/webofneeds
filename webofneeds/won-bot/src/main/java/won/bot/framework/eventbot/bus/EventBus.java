...
public interface EventBus {
    ...
    /**
     * Subscribes a listener to an event type. If the listener implements the SubscriptionAware interface, its
     * onSubscribe() method will be called before the bot is subscribed.
     * 
     * @param eventClazz
     * @param listener
     * @param <T>
    ...
    /**
     * Unsubscribes a listener from an event type. If the listener implements the SubscriptionAware interface, its
    ...
    /**
     * Unsubscribes a listener from all event types it is currently subscribed to. If the listener implements the
     * SubscriptionAware interface, its onUnsubscribe() method will be called after the bot is unsubscribed.
     * 
     * @param listener
     */
