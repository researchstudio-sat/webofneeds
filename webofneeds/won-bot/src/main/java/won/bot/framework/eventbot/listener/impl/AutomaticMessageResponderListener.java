...
/**
 * Listener that responds to open and message events with automatic messages. Can be configured to apply a timeout
 * (non-blocking) before sending messages. Can be configured to send a fixed number of messages and then unsubscribe
 * from events.
 */
