...
public abstract class AbstractCreateNeedAction extends BaseEventBotAction {
    ...
    /**
     * Creates a need with the specified facets. If no facet is specified, the chatFacet will be used, Flag
     * 'UsedForTesting' will be set. uriListName is used from the set botcontextwrapper getNeedCreateListName
     */
