...
/**
 * Composite Needproducer that will cycle through needFactories, returning a different one each time. The order of the
 * factories returned may change (implemented based on a Set not a List).
 */
