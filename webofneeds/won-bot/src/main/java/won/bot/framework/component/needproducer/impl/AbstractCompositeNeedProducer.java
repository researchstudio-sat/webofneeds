...
/**
 * NeedProducer that needFactories to a list of need factories. Order of delegate request is not guaranteed. Not thread
 * safe.
 */
public abstract class AbstractCompositeNeedProducer implements NeedProducer {
    ...
    /**
     * Returns one of the NeedProducer objects found in the needFactories set, or null if no factories are elegible (in
     * which case the factory is exhausted).
     * 
     * @return
     */
