...
/**
 * Publishes BotTriggerEvents on the eventBus at configurable intervals. Upon call to activate() the BotTrigger
 * registers an event listener for the StartBotTrigger event and the StopBotTriggerEvent After receiving the
