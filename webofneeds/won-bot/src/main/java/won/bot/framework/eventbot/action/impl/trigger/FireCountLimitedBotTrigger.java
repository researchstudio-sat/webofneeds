...
/**
 * A BotTrigger that will fire in specified intervals until its fireCount is reached. Additional firings can be added
 * using addFirings().
 * 
 * The trigger tries to speed up and slow down in order to fire as often as possible, but only when it is allowed to.
 * 
 * @author fkleedorfer
 * 
 *
