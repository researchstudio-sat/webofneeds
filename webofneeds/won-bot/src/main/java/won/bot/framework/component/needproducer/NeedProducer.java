...
/**
 * Interface for producing needs. The needs produced must be suitable as the 'model' argument to the createNeed protocol
 * method (i.e., don't have a URI, and only contain user-definable data).
 *
