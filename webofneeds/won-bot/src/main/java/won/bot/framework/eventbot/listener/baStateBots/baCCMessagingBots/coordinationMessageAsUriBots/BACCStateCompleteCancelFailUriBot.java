 ...
 */
public class BACCStateCompleteCancelFailUriBot extends BATestBotScript {
    ...
    protected List<BATestScriptAction> setupActions() {
        ...
        actions.add(new BATestScriptAction(false, URI.create(WON_TX
          .MESSAGE_CANCEL.getURI()), URI.create(WON_TX.STATE_COMPLETING.getURI())));
        actions.add(new BATestScriptAction(true, URI.create(WON_TX
          .MESSAGE_FAIL.getURI()), URI.create(WON_TX.STATE_CANCELING_COMPLETING.getURI())));
        actions.add(new BATestScriptAction(false, URI.create(WON_TX
