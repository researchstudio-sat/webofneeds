...
public class LocalResponseEventFilter implements EventFilter {
    ...
    public LocalResponseEventFilter(final URI responseSenderAtomURI, final URI messageURI) {
        this.responseSenderAtomURI = responseSenderAtomURI;
        this.originalMessageURI = messageURI;
    }

    public static LocalResponseEventFilter forWonMessage(WonMessage wonMessage) {
        return new LocalResponseEventFilter(
