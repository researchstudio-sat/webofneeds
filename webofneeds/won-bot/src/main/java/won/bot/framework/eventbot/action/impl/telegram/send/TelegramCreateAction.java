  ...
  protected void doRun(Event event, EventListener executingListener) throws Exception {
    ...
    if (event instanceof TelegramCreateNeedEvent && ctx.getBotContextWrapper() instanceof TelegramBotContextWrapper) {
      ...
      try {
        ...
        WonMessage createNeedMessage = createWonMessage(wonNodeInformationService, needURI, wonNodeUri, needDataset,
        ...
        EventListener successCallback = new EventListener() {
          ...
          public void onEvent(Event event) throws Exception {
            ...
            try {
              Message message = telegramCreateNeedEvent.getAbsSender().sendMessage(
                  wonTelegramBotHandler.getTelegramMessageGenerator().getCreatedNeedMessage(chatId, needURI));
