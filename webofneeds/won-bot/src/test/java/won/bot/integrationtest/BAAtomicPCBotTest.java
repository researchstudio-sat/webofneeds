...
import won.bot.impl.BAAtomicPCBot;
...
public class BAAtomicPCBotTest {
     ...
     */
    @Test
    public void testBAAtomicPCBot() throws Exception {
        // now check the results!
        logger.info("start test case testBAAtomicPCBot");
        bot.executeAsserts();
        logger.info("finishing test case testBAAtomicPCBot");
    }

    @Test
    public void testBAAtomicPCRDF() {
        logger.info("starting test case testBAAtomicPCRDF");
        bot.executeRDFValidationAssert();
        logger.info("finishing test case testBAAtomicPCRDF");
    }

    @Test
    public void testBAAtomicPCBAStateRDF() {
        logger.info("starting test case testBAAtomicPCBAStateRDF");
        bot.executeBAStateRDFValidationAssert();
        logger.info("finishing test case testBAAtomicPCBAStateRDF");
    }
     ...
     */
    public static class MyBot extends BAAtomicPCBot {
        /**
