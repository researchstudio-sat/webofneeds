...
import won.bot.impl.BAAtomicPCActiveExitingBot;
...
public class BAAtomicPCActiveExitingBotTest {
     ...
     */
    @Test
    public void testBAAtomicPCActiveExitingBot() throws Exception {
        // now check the results!
        logger.info("start test case testBAAtomicPCActiveExitingBot");
        bot.executeAsserts();
        logger.info("finishing test case testBAAtomicPCActiveExitingBot");
    }

    @Test
    public void testBAAtomicPCActiveExitingRDF() {
        logger.info("starting test case testBAAtomicPCActiveExitingRDF");
        bot.executeRDFValidationAssert();
        logger.info("finishing test case testBAAtomicPCActiveExitingRDF");
    }

    @Test
    public void testBAAtomicPCActiveExitingBAStateRDF() {
        logger.info("starting test case testBAAtomicPCActiveExitingBAStateRDF");
        bot.executeBAStateRDFValidationAssert();
        logger.info("finishing test case testBAAtomicPCActiveExitingBAStateRDF");
    }
     ...
     */
    public static class MyBot extends BAAtomicPCActiveExitingBot {
        /**
