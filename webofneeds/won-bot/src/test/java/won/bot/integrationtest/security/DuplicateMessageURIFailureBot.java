...
public class DuplicateMessageURIFailureBot extends IntegrationtestBot {
  @Override protected void initializeEventListeners() {
    ...
    bus.subscribe(NeedCreatedEvent.class, new ActionOnceAfterNEventsListener(ctx, 2, new MultipleActions(ctx,
            new LogErrorAction(ctx, "Should not have been able to create 2 needs using message with identical URIs"),
    ...
    bus.subscribe(NeedCreatedEvent.class, new ActionOnFirstNEventsListener(ctx, 1,
    ...
    bus.subscribe(NeedCreationFailedEvent.class, new ActionOnFirstNEventsListener(ctx, 1,
    ...
    bus.subscribe(SuccessEvent.class, new ActionOnceAfterNEventsListener(ctx, 2,
