...
import won.bot.impl.BAAtomicCCCompletingFailingBot;
...
public class BAAtomicCCCompletingFailingBotTest {
     ...
     */
    @Test
    public void testBAAtomicCCCompletingFailingBot() throws Exception {
        // now check the results!
        logger.info("start test case testBAAtomicCCCompletingFailingBot");
        bot.executeAsserts();
        logger.info("finishing test case testBAAtomicCCCompletingFailingBot");
    }

    @Test
    public void testBAAtomicCCCompletingFailingRDF() {
        logger.info("starting test case testBAAtomicCCCompletingFailingRDF");
        bot.executeRDFValidationAssert();
        logger.info("finishing test case testBAAtomicCCCompletingFailingRDF");
    }

    @Test
    public void testBAAtomicCCCompletingFailingBAStateRDF() {
        logger.info("starting test case testBAAtomicCCCompletingFailingBAStateRDF");
        bot.executeBAStateRDFValidationAssert();
        logger.info("finishing test case testBAAtomicCCCompletingFailingBAStateRDF");
    }
     ...
     */
    public static class MyBot extends BAAtomicCCCompletingFailingBot {
        /**
