...
public class BAAtomicCCBotTest {
     ...
     */
    @Test
    public void testBAAtomicCCBot() throws Exception {
        // now check the results!
        logger.info("start test case testBAAtomicCCBot");
        bot.executeAsserts();
        logger.info("finishing test case testBAAtomicCCBot");
    }

    @Test
    public void testBAAtomicCCRDF() {
        logger.info("starting test case testBAAtomicCCRDF");
        bot.executeRDFValidationAssert();
        logger.info("finishing test case testBAAtomicCCRDF");
    }

    @Test
    public void testBAAtomicCCBAStateRDF() {
        logger.info("starting test case testBAAtomicCCBAStateRDF");
        bot.executeBAStateRDFValidationAssert();
        logger.info("finishing test case testBAAtomicCCBAStateRDF");
    }
     ...
     */
    public static class MyBot extends BAAtomicCCBot {
        /**
