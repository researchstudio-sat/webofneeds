...
public class BAAtomicCCBotTest {
    ...
    public static class MyBot extends BAAtomicCCBot
    {
        ...
        public void executeAsserts()
        {
            ...
            Assert.assertEquals(2, this.participantNeedCreator.getEventCount());
            ...
            //13 connect, 13 open
            Assert.assertEquals(1*(2+2), this.autoOpener.getEventCount());
            Assert.assertEquals(0, this.autoOpener.getExceptionCount());
            //messages
            Assert.assertEquals(1*(2+4+4), this.autoResponder.getEventCount());
