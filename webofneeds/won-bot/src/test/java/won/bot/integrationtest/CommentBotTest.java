...
@RunWith(SpringJUnit4ClassRunner.class) @ContextConfiguration(locations = {
    "classpath:/spring/app/simpleCommentTest.xml" }) public class CommentBotTest {
   ...
   * @throws Exception
   */
  @Test public void testCommentBot() throws Exception {
  ...
  public static class MyBot extends CommentBot {
    ...
    @Override protected void executeAssertionsForEstablishedConnection() {
    ...
    public void executeCommentRDFValidationAssert() {
      ...
      Dataset dataModel = linkedDataSource
          .getDataForResourceWithPropertyPath(needs.get(0), PropertyPathConfigurator.configurePropertyPaths(), 30, 8,
              true);
