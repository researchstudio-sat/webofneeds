...
import won.bot.impl.BAAtomicPCActiveFailingBot;
...
public class BAAtomicPCActiveFailingBotTest {
     ...
     */
    @Test
    public void testBAAtomicPCActiveFailingBot() throws Exception {
        // now check the results!
        logger.info("start test case testBAAtomicPCActiveFailingBot");
        bot.executeAsserts();
        logger.info("finishing test case testBAAtomicPCActiveFailingBot");
    }

    @Test
    public void testBAAtomicPCActiveFailingRDF() {
        logger.info("starting test case testBAAtomicPCActiveFailingRDF");
        bot.executeRDFValidationAssert();
        logger.info("finishing test case testBAAtomicPCActiveFailingRDF");
    }

    @Test
    public void testBAAtomicPCActiveFailingBAStateRDF() {
        logger.info("starting test case testBAAtomicPCActiveFailingBAStateRDF");
        bot.executeBAStateRDFValidationAssert();
        logger.info("finishing test case testBAAtomicPCActiveFailingBAStateRDF");
    }
     ...
     */
    public static class MyBot extends BAAtomicPCActiveFailingBot {
        /**
        ...
        public void executeBAStateRDFValidationAssert() {
            ...
            String queryString = sparqlPrefix + "SELECT ?need ?connection ?need2 WHERE {"
                    ...
                    + "?connection2 won:belongsToNeed ?need2." + "?connection2 won:hasFacet won:BAPCParticipantFacet. "
