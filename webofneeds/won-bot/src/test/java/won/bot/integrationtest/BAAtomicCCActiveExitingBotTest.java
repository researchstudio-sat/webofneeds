...
public class BAAtomicCCActiveExitingBotTest {
    ...
    public void testBAAtomicCCActiveExitingBot() throws Exception {
        ...
        logger.info("start test case testBAAtomicCCActiveExitingBot");
        bot.executeAsserts();
        logger.info("finishing test case testBAAtomicCCActiveExitingBot");
    }

    @Test
    public void testBAAtomicCCActiveExitingRDF() {
        logger.info("starting test case testBAAtomicCCActiveExitingRDF");
        bot.executeRDFValidationAssert();
        logger.info("finishing test case testBAAtomicCCActiveExitingRDF");
    }

    @Test
    public void testBAAtomicCCActiveExitingBAStateRDF() {
        logger.info("starting test case testBAAtomicCCActiveExitingBAStateRDF");
        bot.executeBAStateRDFValidationAssert();
        logger.info("finishing test case testBAAtomicCCActiveExitingBAStateRDF");
    }
