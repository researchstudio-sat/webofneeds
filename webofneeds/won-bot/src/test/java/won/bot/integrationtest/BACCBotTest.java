...
public class BACCBotTest {
    ...
    public void testBACCBot() throws Exception {
        ...
        logger.info("start test case testBACCBot");
        bot.executeAsserts();
        logger.info("finishing test case testBACCBot");
    }

    @Test
    public void testBACCRDF() {
        logger.info("starting test case testBACCRDF");
        bot.executeRDFValidationAssert();
        logger.info("finishing test case testBACCRDF");
    }

    @Test
    public void testBACCBAStateRDF() {
        logger.info("starting test case testBACCBAStateRDF");
        bot.executeBAStateRDFValidationAssert();
        logger.info("finishing test case testBACCBAStateRDF");
    }
    ...
    public static class MyBot extends BACCBot {
        ...
        public void executeRDFValidationAssert() {
            ...
            String queryString = sparqlPrefix + "SELECT ?need ?connection ?need2 WHERE {"
                    ...
                    + "?connection won:hasFacet won:BACCCoordinatorFacet."
