...
public class WonMessageValidatorTest {
    ...
    public void testValidForwardToReceiverMessage() throws IOException {
        ...
        boolean valid = validator
                .validate(Utils.createTestDataset("/validation/valid/conversation_msg_with_forward.trig"), message);
        Assert.assertTrue("validation is expected not to fail at " + message, valid);
    }
    ...
    public void testSignatureChainParallelToEnvelopeChain() throws IOException {
        ...
        // create a dataset where the first envelope references the signature of the second envelope instead of
        // content's
