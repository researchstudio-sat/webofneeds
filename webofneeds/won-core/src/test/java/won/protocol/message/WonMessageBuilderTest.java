...
public class WonMessageBuilderTest {
  ...
  public void test_wrap_retains_content_graphs() {
    ...
    Assert.assertEquals(TYPE_URI_1.toString(), RdfUtils
        .findOnePropertyFromResource(msg2.getMessageContent(), MSG_URI_1, RDF.type).asResource().getURI().toString());
  }
  ...
  public void test_wrap_allows_new_content_graphs() {
    ...
    Assert.assertEquals(TYPE_URI_2.toString(), RdfUtils
        .findOnePropertyFromResource(msg2.getMessageContent(), MSG_URI_2, RDF.type).asResource().getURI().toString());
  }
  ...
  private WonMessageBuilder createMessageWithContent() {
    return new WonMessageBuilder(MSG_URI_1).addContent(createContent()).setWonMessageType(WonMessageType.HINT_MESSAGE)
        .setWonMessageDirection(WonMessageDirection.FROM_OWNER);
  }
  ...
  private WonMessageBuilder createMessageWithTwoContentGraphs() {
    return new WonMessageBuilder(MSG_URI_1).addContent(createContent()).addContent(createDifferentContent())
        .setWonMessageType(WonMessageType.HINT_MESSAGE).setWonMessageDirection(WonMessageDirection.FROM_OWNER);
  }
