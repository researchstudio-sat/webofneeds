...
public class WonMessageTest {
  ...
  public void testForwardedMessage1() {
    ...
    Assert.assertEquals(URI.create("https://satvm05.researchstudio.at/won/resource/connection/zy478j5k7roa38f2ao9l"),
        msg.getSenderURI());
    Assert.assertEquals(URI.create("https://satvm05.researchstudio.at/won/resource/connection/nz3dg71sop2v5f82j3lm"),
        msg.getReceiverURI());
