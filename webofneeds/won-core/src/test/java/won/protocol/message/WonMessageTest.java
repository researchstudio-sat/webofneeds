...
public class WonMessageTest {
    ...
    public void testForwardedMessage1() {
        ...
        Assert.assertEquals(URI.create("https://satvm05.researchstudio.at/won/resource/event/hsvug43m3rvz9qei25zh"), msg.getMessageURI());
        Assert.assertEquals(URI.create("https://satvm05.researchstudio.at/won/resource/event/pcunhsv1urpd2q3bfpan"), msg.getCorrespondingRemoteMessageURI());
