...
/src/test/resources/need-lifecycle_with_messages_02/
...
1. base prefix (or other prefix) should map to URI part up to # or last path part,
   ...
   in the current code, it is always assumed there, that the base URI is the current need URI;
2. [randomNeedID_1] (and similar) as part of the URI are replaced by randomNeedID_1,
...
In directory "01_create_need" an owner creates a need (N1) at WN1.
In directory "02_connect" the owner sends a connect from N1 to another need (N2) at WN2.
