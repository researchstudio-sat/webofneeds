...
public abstract class AbstractKeyStoreService implements KeyStoreService {
     ...
     * (non-Javadoc)
     * 
     * @see won.cryptography.service.KeyStoreService#getCertificate(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see won.cryptography.service.KeyStoreService#getCertificateAlias(java.security. cert.Certificate)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see won.cryptography.service.KeyStoreService#putKey(java.lang.String, java.security.PrivateKey,
     ...
     * (non-Javadoc)
     * 
     * @see won.cryptography.service.KeyStoreService#putCertificate(java.lang.String, java.security.cert.Certificate,
     * boolean)
     */
    @Override
    ...
    /**
     * Adding of all the entries into the key store should happen in only one place - in this method - because otherwise
     * there could be concurrency issues when one entry is replace with the other even when the calling method sets
     * replace=false.
     *
     * @param alias
     * @param key
