...
public class CertificateService {
     ...
     *
     * @param serialNumber
     *            unique number within the certificate issuer
     * @param key
     *            key pair for which the certificate is to be created
     * @param commonName
     *            subject common name. For servers, this should be the host name. E.g. if a server supports https at
     *            https://www.example.com/secure, the common name should be specified as www.example.com. For clients,
     *            it can be anything.
     * @param webId
     *            webID that represents the identity of the subject or null if the subject has no webID
     * @return
     * @throws IOException
     */
     ...
     *            key pair for which the certificate is to be created.
     * @param subjectData
     *            subject data to be put in distinguished name field of the certificate. Such as CN - common name, O -
     *            organization, OU - organization unit, L - locality, C - county, etc.
     * @param webId
     *            webID that represents the identity of the subject or null if the subject has no webID.
     * @return
     * @throws IOException
