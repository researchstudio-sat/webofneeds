...
/**
 * Helper interface for extracting information out of a (public key). Has to be implemented for specific formats (e.g.
 * Bouncy Castle).
 *
...
public interface KeyInformationExtractor {
     ...
     * 
     * @param key
     *            <code>Key</code> representing a private or public key
     ...
     * 
     * @param publicKey
     *            <code>PublicKey</code> representing the public key
     * @return <code>String</code> with base 16 notated number representing the x coordinate
     */
     ...
     * @param publicKey
     *            <code>PublicKey</code> representing the public key
     * @return <code>String</code> with base 16 notated number representing the y coordinate
     */
