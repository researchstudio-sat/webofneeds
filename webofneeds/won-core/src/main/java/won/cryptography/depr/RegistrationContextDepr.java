 ...
 * Date: 15.10.2015
 */
public class RegistrationContextDepr
{
  ...
  // it...
  public RegistrationContextDepr(KeyStoreService keyStoreService, PrivateKeyStrategy privateKeyStrategy, TrustStoreService
    trustStoreService) {
