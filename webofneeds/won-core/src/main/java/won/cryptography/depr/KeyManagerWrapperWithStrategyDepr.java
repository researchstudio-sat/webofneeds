 ...
 */
public class KeyManagerWrapperWithStrategyDepr implements X509KeyManager
{
  private final X509KeyManager keyManager;
  private final PrivateKeyStrategy aliasStrategy;

  public KeyManagerWrapperWithStrategyDepr(final X509KeyManager keyManager, final PrivateKeyStrategy aliasStrategy) {
    super();
