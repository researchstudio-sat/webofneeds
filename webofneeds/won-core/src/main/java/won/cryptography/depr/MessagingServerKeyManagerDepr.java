 ...
 * Date: 08.10.2015
 */
//TODO if works for server, replace with initializing keymanager from messagingcontext
public class MessagingServerKeyManagerDepr implements X509KeyManager
{
...
//  public MessagingServerKeyManager(WonTlsSecurityConfig config) {
//    try {
//      keyManagerFromConfig = config.getMessagingServerKeyManager();
//    } catch (Exception e) {
//      logger.error("Error initializing KeyManager for messaging for server-side", e);
