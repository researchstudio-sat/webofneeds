...
/**
 * Can be useful for development: a certificate will become trusted after application of this strategy, while if already
 * a certificated under the same alias is stored, it will be replaced by this latest certificate.
 *
