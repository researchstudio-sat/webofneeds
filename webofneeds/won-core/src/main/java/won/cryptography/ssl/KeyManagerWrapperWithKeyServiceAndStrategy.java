 ...
 * of class TrustManagerDelegate of org.apache.http.conn.ssl .SSLContextBuilder
 * Unfortunately, they don't provide it as public class. It is useful when the
 * default implementation of X509KeyManager is used but additionally the
 * strategy of how to choose the key when the key store contains many keys is
 * applied. For original see:
