...
/**
 * Trust on first use strategy: if certificate is already known and trusted (from previous communication) - trust it. If
 * not yet in the store, and we can successfully add it to the store (no alias collision based on the provided alias
