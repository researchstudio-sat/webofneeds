...
/**
 * Monitoring statistics recorder that can be configured to write new files conforming
 * to a specified filename pattern into a specified directory. If no directory
