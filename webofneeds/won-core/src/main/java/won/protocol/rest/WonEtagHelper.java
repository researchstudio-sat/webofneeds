...
public class WonEtagHelper {
    ...
    /**
     * Returns a WonEtagHelper if the specified string is a valid ETAG, combining [VERSION] {[DELIMITER] [MEDIA-TYPE]}
     * (curly brackets inticate 'optional') Returns null if the specified etagValue is null or not valid.
     * 
     * @param etagValue
     * @return
     */
     ...
     * different from the one the server will produce now. If there is no Accept header, the helper object will be
     * returned. If parsing the ETAG does not reveal a MediaType, the helperObject will not be returned.
     * 
     * @param headers
     * @return
     */
