...
public abstract class MessageContainer implements VersionedEntity {
    ...
    private Collection<MessageInContainer> events = new ArrayList<>(1);
    ...
    public Collection<MessageInContainer> getEvents() {
        return events;
    }

    public void setEvents(final Collection<MessageInContainer> events) {
        this.events = events;
    }
