...
@Table(name = "connection", indexes = {
        @Index(name = "IDX_CONNECTION_NEEDURI_REMOTENEEDURI", columnList = "needURI, remoteNeedURI"), }, uniqueConstraints = {
                ...
                @UniqueConstraint(name = "IDX_UNIQUE_CONNECTION", columnNames = { "needURI", "remoteNeedURI",
                        "facetURI", "remoteFacetURI" }) })
public class Connection implements ParentAware<ConnectionContainer>, VersionedEntity {
    ...
    /*
     * The uri of the facet. This must be a resource defined in the need's content. The type of that resource is the
     * typeURI
     */
    ...
    /*
     * The uri of the remote facet. This must be a resource defined in the remote need's content or null, if we don't
     * know it yet
     */
