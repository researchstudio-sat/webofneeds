...
public class DataWithEtag<T> {
    ...
    /**
     * Creates a DWE that indicates nothing has changed. May be useful if the type of the object at hand has the wrong
     * generic type.
     * 
     * @param data
     * @return
    ...
    /**
     * 
     * This method allows querying if the data is deleted. Only returns true if isDeleted was explicitly set to true
     * before.
     * 
     * @return
     */
    ...
    /**
     *
     * This method allows querying if the data is null because it was not found. Only returns true if notFound was
     * explicitly set to true before.
     * 
     * @return
     */
