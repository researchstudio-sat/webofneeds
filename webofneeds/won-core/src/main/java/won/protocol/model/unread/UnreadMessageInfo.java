...
public class UnreadMessageInfo {
    ...
    public UnreadMessageInfo aggregateWith(UnreadMessageInfo other) {
        return new UnreadMessageInfo(this.count + other.count,
                        this.newestTimestamp.after(other.newestTimestamp) ? this.newestTimestamp
                                        : other.newestTimestamp,
                        this.oldestTimestamp.after(other.oldestTimestamp) ? other.oldestTimestamp
