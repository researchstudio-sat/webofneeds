...
/**
 * Created with IntelliJ IDEA. User: gabriel Date: 12.09.13 Time: 18:11 To change this template use File | Settings |
 * File Templates.
 */
public enum FacetType {
    ChatFacet("ChatFacet"), HolderFacet("HolderFacet"), HoldableFacet("HoldableFacet"), GroupFacet(
            "GroupFacet"), ReviewFacet("ReviewFacet"), CoordinatorFacet("CoordinatorFacet"), ParticipantFacet(
                    "ParticipantFacet"), CommentFacet(
                            "CommentFacet"), CommentModeratedFacet("CommentModeratedFacet"), CommentUnrestrictedFacet(
                                    "CommentUnrestrictedFacet"), ControlFacet("ControlFacet"), BAPCCoordinatorFacet(
                                            "BAPCCoordinatorFacet"), BAPCParticipantFacet(
                                                    "BAPCParticipantFacet"), BACCCoordinatorFacet(
                                                            "BACCCoordinatorFacet"), BACCParticipantFacet(
                                                                    "BACCParticipantFacet"), BAAtomicPCCoordinatorFacet(
                                                                            "BAAtomicPCCoordinatorFacet"), BAAtomicCCCoordinatorFacet(
                                                                                    "BAAtomicCCCoordinatorFacet");
