  ...
  public Dataset getDataset() {
    ...
    synchronized (this) {
      ...
      try {
        ...
        logger.warn("could not read dataset {} from byte array. Byte array is null: {}, has length {}", new Object[] {
            this.uri, this.datasetBytes == null, this.datasetBytes == null ? -1 : this.datasetBytes.length });
