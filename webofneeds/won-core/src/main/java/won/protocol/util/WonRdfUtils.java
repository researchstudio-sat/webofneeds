...
public class WonRdfUtils {
    ...
    public static class WonNodeUtils {
        /**
         * Creates a WonNodeInfo object based on the specified dataset. The first model found in the dataset that seems
         * to contain the data needed for a WonNodeInfo object is used.
         * 
         * @param wonNodeUri
         * @param dataset
         * @return
    ...
    public static class MessageUtils {
        ...
        /**
         * Creates an RDF model containing a feedback message referring to the specified resource that is either
        ...
        /**
         * Returns the first won:hasTextMessage object, or null if none is found. Won't work on WonMessage models,
         * removal depends on refactoring of BA facet code
         * 
         * @param model
         * @return
         */
        ...
        /**
         * Returns the first won:hasTextMessage object, or null if none is found. tries the message, its corresponding
         * remote message, and any forwarded message, if any of those are contained in the dataset
         *
         * @param wonMessage
         * @return
         */
    ...
    public static class FacetUtils {
        ...
        /**
         * Returns the facet in a connect message. Attempts to get it from the specified message itself. If no such
         * facet is found there, the remoteFacet of the correspondingRemoteMessage is used.
         * 
         * @param message
         * @return
         */
        ...
        /**
         * Returns the remoteFacet in a connect message. Attempts to get it from the specified message itself. If no
         * such facet is found there, the facet of the correspondingRemoteMessage is used.
         * 
         * @param message
         * @return
         */
        ...
        /**
         * Returns a property of the message (i.e. the object of the first triple ( [message-uri] [property] X ) found
         * in one of the content graphs of the specified message.
         */
         ...
         * [corresponding-remote-message-uri] [property] X ) found in one of the content graphs of the specified
         * message.
         */
        ...
        /**
         * Returns all facets found in the model, attached to the null relative URI '<>'. Returns an empty collection if
        ...
        /**
         * Returns the default facet found in the model. If there is no default facet, the result is empty. unless
         * returnAnyIfNoDefaultFound is true, in which case any facet may be returned. and there is no default facet,
         * any facet may be returned
         * 
         * @param model
         * @param subject
         * @param boolean
        ...
        /**
         * Creates a model for connecting two facets. Both facets are optional, if none are given the returned Optional
         * is empty
         * 
         * @return
         */
    ...
    public static class ConnectionUtils {
         ...
         *
         * @param dataset
         *            <code>Dataset</code> object which contains connection information
         * @param connectionURI
         * @return <code>URI</code> of the need
         */
        public static URI getLocalNeedURIFromConnection(Dataset dataset, final URI connectionURI) {
            return URI.create(
                    findOnePropertyFromResource(dataset, connectionURI, WON.BELONGS_TO_NEED).asResource().getURI());
        }

        public static URI getRemoteNeedURIFromConnection(Dataset dataset, final URI connectionURI) {
            return URI.create(
                    findOnePropertyFromResource(dataset, connectionURI, WON.HAS_REMOTE_NEED).asResource().getURI());
        }

        public static URI getWonNodeURIFromConnection(Dataset dataset, final URI connectionURI) {
            return URI.create(
                    findOnePropertyFromResource(dataset, connectionURI, WON.HAS_WON_NODE).asResource().getURI());
        }
    ...
    public static class NeedUtils {
         ...
         *
         * @param dataset
         *            <code>Dataset</code> object which will be searched for the NeedURI
         ...
         *
         * @param model
         *            <code>Model</code> object which will be searched for the NeedURI
         * @return <code>URI</code> which is of type won:Need
         */
        ...
        /**
         * Assumes that the dataset contains a need's connection information, looks for the specified remote needs and
         * returns the remote connection uris. Optionally the result can be filtered by connection state.
         */
