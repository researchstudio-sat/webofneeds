...
public interface NeedBuilder<T>
{
  ...
  public NeedBuilder<T> setUpperPriceLimit(Float price);
  public NeedBuilder<T> setLowerPriceLimit(Float price);
  public NeedBuilder<T> setUpperPriceLimit(String price);
  public NeedBuilder<T> setLowerPriceLimit(String price);
