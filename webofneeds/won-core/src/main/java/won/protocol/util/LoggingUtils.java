...
public class LoggingUtils {
  ...
  /**
   * Logs a message on loglevel INFO and the exception's stack trace on DEBUG. The log message will contain the 
   * specified message plus the exception class and the exception message.  
   * 
   * @param logger a Log4j logger
   * @param message a String used as a log4j message. Use curly braces ('{}') as placeholders for message params.
