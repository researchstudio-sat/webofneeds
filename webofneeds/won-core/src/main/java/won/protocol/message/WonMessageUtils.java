...
public class WonMessageUtils {
    ...
    /**
     * If the message is a ResponseMessage (SuccessResponse or FailureResponse) this method returns the message that was
     * responded to and that belongs to the same parent as the specified message.
     * 
     * @param message
