...
public class WonMessageBuilder {
  ...
  public WonMessage build(final Dataset dataset) throws WonMessageBuilderException {
    ...
    for (URI contentURI : contentMap.keySet()) {
      ...
      if (signatureGraph != null) {
         ...
         * 
         * uniqueContentUri = RdfUtils.createNewGraphURI(contentURI.toString(),
         * SIGNATURE_URI_SUFFIX, 5, dataset).toString(); //the signature refers to the
         * name of the other graph. We changed that name //so we have to replace the
         * resource referencing it, too: signatureGraph =
  ...
  public static WonMessageBuilder setMessagePropertiesForOpen(URI messageURI, URI localConnection, URI localNeed,
    ...
    WonMessageBuilder builder = new WonMessageBuilder(messageURI).setWonMessageDirection(WonMessageDirection.FROM_OWNER)
        .setWonMessageType(WonMessageType.OPEN).setSenderURI(localConnection).setSenderNeedURI(localNeed)
  ...
  public static WonMessageBuilder setMessagePropertiesForOpen(URI messageURI, WonMessage connectToReactTo,
    ...
    return setMessagePropertiesForOpen(messageURI, connectToReactTo.getReceiverURI(),
        connectToReactTo.getReceiverNeedURI(), connectToReactTo.getReceiverNodeURI(), connectToReactTo.getSenderURI(),
        connectToReactTo.getSenderNeedURI(), connectToReactTo.getSenderNodeURI(),
        Optional.of(connectToReactTo.getSenderFacetURI()), welcomeMessage);
  }
  ...
  public static WonMessageBuilder setMessagePropertiesForClose(URI messageURI, WonMessageDirection direction,
      URI localConnection, URI localNeed, URI localWonNode, URI remoteConnection, URI remoteNeed, URI remoteWonNode,
      String farewellMessage) {

    return new WonMessageBuilder(messageURI).setWonMessageDirection(direction).setWonMessageType(WonMessageType.CLOSE)
  ...
  public static WonMessageBuilder setMessagePropertiesForNeedMessageFromSystem(URI messageURI, URI localNeed,
      URI localWonNode) {
    return new WonMessageBuilder(messageURI).setWonMessageDirection(WonMessageDirection.FROM_SYSTEM)
        .setWonMessageType(WonMessageType.NEED_MESSAGE).setSenderNeedURI(localNeed).setSenderNodeURI(localWonNode)
        .setReceiverNeedURI(localNeed).setReceiverNodeURI(localWonNode).setSentTimestampToNow();
  }
  ...
  public static WonMessageBuilder setMessagePropertiesForConnect(URI messageURI, Optional<URI> localFacet,
    ...
    WonMessageBuilder builder = new WonMessageBuilder(messageURI).setWonMessageDirection(WonMessageDirection.FROM_OWNER)
        .setWonMessageType(WonMessageType.CONNECT).setSenderNeedURI(localNeed).setSenderNodeURI(localWonNode)
  ...
  public static WonMessageBuilder setMessagePropertiesForHint(URI messageURI, URI needURI, Optional<URI> needFacetURI,
    ...
    WonMessageBuilder builder = new WonMessageBuilder(messageURI)
        .setWonMessageDirection(WonMessageDirection.FROM_EXTERNAL).setWonMessageType(WonMessageType.HINT_MESSAGE)
        .setSenderNodeURI(matcherURI).setReceiverNeedURI(needURI).setReceiverNodeURI(wonNodeURI);
  ...
  public static WonMessageBuilder setMessagePropertiesForConnectionMessage(URI messageURI, URI localConnection,
    ...
    return new WonMessageBuilder(messageURI).setWonMessageDirection(WonMessageDirection.FROM_OWNER)
        .setWonMessageType(WonMessageType.CONNECTION_MESSAGE).setSenderURI(localConnection).setSenderNeedURI(localNeed)
        .setSenderNodeURI(localWonNode).setReceiverURI(remoteConnection).setReceiverNeedURI(remoteNeed)
        .setReceiverNodeURI(remoteWonNode).addContent(content).setSentTimestampToNow();
  }

  public static WonMessageBuilder setMessagePropertiesForConnectionMessage(URI messageURI, URI localConnection,
      URI localNeed, URI localWonNode, URI remoteConnection, URI remoteNeed, URI remoteWonNode, String textMessage) {
    return new WonMessageBuilder(messageURI).setWonMessageDirection(WonMessageDirection.FROM_OWNER)
        .setWonMessageType(WonMessageType.CONNECTION_MESSAGE).setSenderURI(localConnection).setSenderNeedURI(localNeed)
        .setSenderNodeURI(localWonNode).setReceiverURI(remoteConnection).setReceiverNeedURI(remoteNeed)
        .setReceiverNodeURI(remoteWonNode).setTextMessage(textMessage).setSentTimestampToNow();
  }
  ...
  public static WonMessageBuilder setPropertiesForNodeResponse(WonMessage originalMessage, boolean isSuccess,
    ...
    if (WonMessageDirection.FROM_EXTERNAL == origDirection) {
      ...
      messageBuilder.setSenderNodeURI(originalMessage.getReceiverNodeURI())
          .setSenderNeedURI(originalMessage.getReceiverNeedURI()).setSenderURI(originalMessage.getReceiverURI())
  ...
  public static WonMessage forwardReceivedNodeToNodeMessageAsNodeToNodeMessage(final URI newMessageUri,
    ...
    WonMessageBuilder builder = new WonMessageBuilder(newMessageUri).setWonMessageType(wonMessage.getMessageType())
        ...
        .setReceiverURI(remoteConnectionURI).setReceiverNeedURI(remoteNeedURI).setReceiverNodeURI(remoteWonNodeUri)
