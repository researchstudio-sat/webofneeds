...
/**
 * First processor for incoming messages. It expects a serialized WonMessage in TriG format in the exchange's in, in the
 * body or a WonMessage object in the in header 'wonMessgage'. If that header is empty, the WonMessage found in the body
 * is deserialized and put into the in header 'wonMessage'. Moreover, the 'messageType' header is set.
 *
    ...
    public void process(final Exchange exchange) throws Exception {
        ...
        if (wonMessage == null) {
            try {
                ...
                logger.info(
                        "could not decode message as TriG, ignoring it (the offending message is logged at loglevel 'DEBUG')",
                        e);
