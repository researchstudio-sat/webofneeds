...
public class WonMessageEncoder {
    ...
    /**
     * Encodes the WonMessage object as serialized RDF in the given language. If no WonMessage object is provided an
     * empty string is returned.
     *
     * @param message
     *            <code>WonMessage</code> object which will be serialized
     * @param lang
     *            defines the serialization language
     * @return <code>String</code> containing the serialized RDF; if no WonMessage is provided an empty string is
     *         returned
     */
