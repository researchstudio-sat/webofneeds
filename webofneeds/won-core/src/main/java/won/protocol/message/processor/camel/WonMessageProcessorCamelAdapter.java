...
/**
 * Adapts a WonMessageProcessor to act as a camel processor. The WonMessage object is expected to be found in
 * <code>exchange.getIn()</code> in the 'wonMessage' header. After successful processing, the resulting wonMessage
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("calling adaptee {} with message {} (type: {}, direction: {}, recipient: {})",
                    new Object[] { adaptee, msg, ((WonMessage) msg).getMessageType(),
                            ((WonMessage) msg).getEnvelopeType(), ((WonMessage) msg).getReceiverURI() });
        }
