...
public class WonJmsConfiguration extends JmsConfiguration {
    ...
    public void configureDefaultJmsConfiguration() {
        ...
        // setRequestTimeout(0);
        setAsyncConsumer(true); // this may improve performance for most cases, but it bites us in the registration
                                // situation, when we actually want to get a result from the wonnode.
