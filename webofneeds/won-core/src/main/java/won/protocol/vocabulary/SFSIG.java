...
public class SFSIG {
  ...
  public static final Resource GRAPH_CANONICALIZATION_METHOD_Fisteus2010 = m
      .createResource(BASE_URI + "gcm-fisteus-2010");
  public static final Resource GRAPH_DIGEST_METHOD_Fisteus2010 = m
      .createResource(BASE_URI + PREFIX_GRAPH_DIGEST_METHOD + "-fisteus-2010");
  public static final Resource DIGEST_METHOD_SHA_256 = m.createResource(BASE_URI + PREFIX_DIGEST_METHOD + "sha-256");
  public static final Resource GRAPH_SERIALIZATION_METHOD_TRIG = m
      .createResource(BASE_URI + PREFIX_GRAPH_SERIALIZATION_METHOD + "trig");
