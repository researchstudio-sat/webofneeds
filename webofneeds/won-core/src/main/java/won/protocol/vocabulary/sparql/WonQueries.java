...
public class WonQueries {
    ...
    public static final String SPARQL_ALL_NEEDS = SPARQL_PREFIX + "SELECT * WHERE " + "{ ?need won:hasContent ?x; "
            ...
            + "won:hasStartTime ?starttime; " + "won:hasRecurInfiniteTimes ?recinf; " + "won:hasRecursIn ?recin." + "}"
            + "}";
    ...
    public static final String SPARQL_NEEDS_FILTERED_BY_URI = SPARQL_PREFIX + "SELECT * WHERE "
            ...
            + "?time won:hasEndTime ?endtime; " + "won:hasStartTime ?starttime; "
            + "won:hasRecurInfiniteTimes ?recinf; " + "won:hasRecursIn ?recin." + "}" + "FILTER (?need in (::need::))"
            + "}";
    ...
    // public static final String SPARQL_MY_NEED = "SELECT * WHERE {?need won:containedInPrivateGraph ?graph. ?need
    // won:hasContent ?x; won:isInState ?state. ?x dc:description ?desc; won:hasTag ?tag; dc:title ?title.}";
    // public static final String SPARQL_NEEDS_FILTERED_BY_UUIDS = "SELECT * WHERE { ?need won:hasContent ?x;
    // won:isInState ?state. ?x dc:description ?desc; won:hasTag ?tag; dc:title ?title. filter (?need in
