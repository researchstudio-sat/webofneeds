...
public interface NeedInformationService {
   ...
   *                      use default
   * @param timeSpot      time at which we want the list state to be fixed, if
   *                      null - current state
   *
   ...
   *
   * @param resumeConnURI     the returned slice connections precede (in time of
   *                          their latest events) this connection uri
   ...
   * the point of view of their latest events.
   *
   * @param resumeConnURI     the returned slice connections follow (in time of
   *                          their latest events) this connection uri
   * @param preferredPageSize preferred number of members per page or null; null
   *                          => use default
   * @param timeSpot          time at which we want the list state to be fixed,
   ...
   * @param preferredPageSize preferred number of members per page or null; null
   *                          => use default
   * @param messageType       event type that should be used for defining
   ...
   *         need with the specified URI or the version number of the etag is
   *         found
   */
