...
public interface NeedInformationService {
    ...
    /**
     * Retrieves a page of the list of needs on the needserver that have a given state with number of need uris per page
     * preference.
     *
     * @param page
     *            the page number
     * @param preferredSize
     *            preferred number of members per page, null => use default
     * @param needState
     *            Active/Inactive, null => all states
     * @return a collection of all need URIs.
     */
    public Slice<URI> listNeedURIs(int page, Integer preferredSize, NeedState needState);

    /**
     * Retrieves list of needs on the needserver that where created earlier than the given need that have a given state
    ...
    /**
     * Retrieves list of needs on the needserver that where created later than the given need that have a given state
     * with number of need uris per page preference.
     *
     * @param need
     * @param preferredSize
     ...
     * 
     * @param modifiedAfter
     *            modification date of the needs to retrieve
     ...
     *            the page number
     * @param preferredSize
     *            preferred number of members per page or null; null => use default
     * @param timeSpot
     *            time at which we want the list state to be fixed, if null - current state
     *
     ...
     *            preferred number of members per page or null; null => use default
     * @param timeSpot
     *            time at which we want the list state to be fixed, cannot be null
     *
     * @return a slice of connection URIs.
     */
    public Slice<URI> listConnectionURIsBefore(final URI resumeConnURI, final Integer preferredPageSize,
            final Date timeSpot);
     ...
     * @return a slice of connection URIs.
     */
    public Slice<URI> listConnectionURIsAfter(final URI resumeConnURI, final Integer preferredPageSize,
            final Date timeSpot);
     ...
     *            preferred number of members per page or null; null => use default
     * @param messageType
     *            event type that should be used for defining connection latest activity; null => all event types
     * @param timeSpot
     *            time at which we want the list state to be fixed, if null - current state
     * @return a collection of connection URIs.
     * @throws won.protocol.exception.NoSuchNeedException
     ...
     * @return a slice of connection URIs.
     */
    public Slice listConnectionURIsBefore(URI needURI, URI resumeConnURI, Integer preferredPageSize,
     ...
     * @return a slice of connection URIs.
     */
    public Slice listConnectionURIsAfter(URI needURI, URI resumeConnURI, Integer preferredPageSize,
            WonMessageType messageType, Date timeSpot);
     ...
     *
     * @param needURI
     *            describes the need to lookup
     * @param etag
     *            describes the version of the data to look up
     * @return need data with corresponding etag version number or null if no need with the specified URI or the version
     *         number of the etag is found
     * @throws NoSuchNeedException
     */
     ...
     *
     * @param connectionURI
     *            describes the connection to lookup
     * @param Etag
     *            describes the version of the data to look up
     * @return connection data with corresponding etag version number or null if no need with the specified URI or the
     *         version number of the etag is found
     */
    ...
    /**
     * Retrieves list of event uris of the specified connection that where created earlier than the given event
     * (specified by event message uri) and that have a given message type, with number of uris per page preference.
     *
     * @param connectionUri
     * @param msgURI
     *            before which the messages should be returned (created before this message msgURI)
     * @param preferredPageSize
     *            preferred number of members per page, null => use default
     * @param msgType
     *            null => all types
     ...
     */
    @Deprecated
    public Slice<URI> listConnectionEventURIsBefore(URI connectionUri, URI msgURI, Integer preferredPageSize,
    ...
    /**
     * Retrieves list of event uris of the specified connection that where created later than the given event (specified
     * by event message uri) and that have a given message type, with number of uris per page preference.
     *
     * @param connectionUri
     * @param msgURI
     *            after which the messages should be returned (created after this message msgURI)
     * @param preferredPageSize
     *            preferred number of members per page, null => use default
     * @param msgType
     *            null => all types
