...
public interface LinkedDataService {
   ...
   *                                   connection data for a member connection uri
   *                                   cannot be retrieved.
   */
   ...
   * @param deep          If deep is true, the resource data of those connection
   ...
   * @param preferredSize preferred number of connection uris per page (null means
   *                      use default)
   * @param timeSpot      date and time that specifies the connections and events
   *                      state of interest
   * @param deep          if true, the resource data of those connection uris is
   *                      also part of the resource
   * @return
   * @throws NoSuchNeedException
   * @throws NoSuchConnectionException only in case deep is set to true and
   *                                   connection data for a member connection uri
   ...
   * @param deep        - if true, connection data is added (not only connection
   *                    URIs)
   * @return
   * @throws NoSuchNeedException
   */
   ...
   * @param messageType   the event type that should be used for defining
   *                      connection latest activity; null => all event types
   ...
   *
   * @param needUri
   * @param deep          - include need's connections datasets and each
   *                      connection's events' datasets
   ...
   * @param preferedSize  preferred number of uris per page, null means use
   *                      default
