...
/**
 * Interface defining methods for need communication. TODO [REFACTORING]: delete
...
public interface MatcherFacingNeedCommunicationService {
     ...
     * matching service. Expects <> won:hasFacet [FACET] in the RDF content, will
     * choose a facet supported by the need if none is present.
     *
