...
/**
 * User: sbyim Date: 25.11.13 This class is used to dynamically generate routes for outgoing messages from owner
 * application.
 */
...
public class OwnerProtocolDynamicRoutes extends RouteBuilder {
     ...
     *
     * @param camelContext
     *            the camelContext where the routes are added
     * @param from
     *            each route has the starting consuming endpoint per node it wants to send the messages to.
     */
