...
public class OwnerProtocolNeedServiceClient implements OwnerProtocolNeedService {
    ...
    //
    private String baseNeedURI;
    //
    private String baseConnectionURI;
    //
    private String ownerProtocolURI;
    ...
    public void setBaseNeedURI(String baseNeedURI) {
        this.baseNeedURI = baseNeedURI;
    }

    public void setBaseConnectionURI(String baseConnectionURI) {
        this.baseConnectionURI = baseConnectionURI;
    }

    public void setOwnerProtocolURI(String ownerProtocolURI) {
        this.ownerProtocolURI = ownerProtocolURI;
    }
    ...
    public URI createNeed(URI ownerURI, Model content, boolean activate) throws IllegalNeedContentException {
        ...
        try {
            OwnerProtocolNeedWebServiceEndpoint proxy = getOwnerProtocolEndpointForNeed(new URI(ownerProtocolURI));
