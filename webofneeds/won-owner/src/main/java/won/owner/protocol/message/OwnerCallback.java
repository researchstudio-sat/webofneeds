...
/**
 * Interface for owner implementations providing methods for receiving specific messages and sending generic messages.
 */
public interface OwnerCallback {
    ...
    /**
     * Called when a message is received that indicates some error during processing of a message previously sent by the
     * bot.
     * 
    ...
    /**
     * Called when a message is received that indicates successful processing of a message previously sent by the bot.
     * 
