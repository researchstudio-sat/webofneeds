...
/**
 * Maps incoming messages from the WonMessageProcessor interface to the WonEventCallback interface. Outgoing messages
 * sent by calling the adaptee's send(msg) method are delegated to the
 */
public abstract class OwnerCallbackAdapter implements WonMessageProcessor {
    ...
    /**
     * Creates a connection object representing the connection on which the message was received.
     *
     * @param wonMessage
     * @return
     */
