    ...
    return transactionTemplate.execute(new TransactionCallback<UserDetails>() {
      ...
      public UserDetails doInTransaction(TransactionStatus status) {
        ...
        if (logger.isDebugEnabled()) {
          logger.debug("Refreshing persistent login token for user '" + persistentLogin.getUsername() + "', series '"
        ...
        KeystoreEnabledUserDetails keystoreEnabledUserDetails = new KeystoreEnabledUserDetails((User) userDetails,
