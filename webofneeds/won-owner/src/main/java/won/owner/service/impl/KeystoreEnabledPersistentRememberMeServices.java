...
public class KeystoreEnabledPersistentRememberMeServices extends PersistentTokenBasedRememberMeServices {
        ...
        return transactionTemplate.execute(new TransactionCallback<UserDetails>() {
            ...
            public UserDetails doInTransaction(TransactionStatus status) {
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug("Refreshing persistent login token for user '" + persistentLogin.getUsername()
                                    + "', series '" + persistentLogin.getSeries() + "'");
                }
                // ------------- begin: added for WoN -----------------------
                ...
                KeystoreEnabledUserDetails keystoreEnabledUserDetails = new KeystoreEnabledUserDetails(
                                (User) userDetails, keystore, keystorePassword);
                keystore = null;
    ...
    protected void onLoginSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        KeystoreEnabledUserDetails keystoreEnabledUserDetails = (KeystoreEnabledUserDetails) successfulAuthentication
                        .getPrincipal();
    ...
    private void addCookies(PersistentLogin persistentLogin, String key, HttpServletRequest request,
        ...
        setCookie(new String[] { persistentLogin.getSeries(), persistentLogin.getToken() }, validity, request,
                        response);
