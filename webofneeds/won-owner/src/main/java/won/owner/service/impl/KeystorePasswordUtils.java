...
public class KeystorePasswordUtils {
    ...
    /*
     * public static void main(String... args) { String password = "supersecretpassword"; String key = "mykey";
     * StopWatch sw = new StopWatch(); sw.start(); System.out.println("encrypting..."); String encrypted =
     * encryptPassword(password, key); sw.stop(); System.out.println("took " + sw.getLastTaskTimeMillis()); sw.start();
     * System.out.println("encrypting " + password + " with key " + key + " to: " + encrypted); String decrypted =
     * decryptPassword(encrypted, key); System.out.println("decrypting again yields: " + decrypted); sw.stop();
    ...
    /**
     * Generates a 1000-fold hash of the specified string toHash, using saltString as salt if non-null.
     * 
     * @param toHash
     * @param hashLength
     *            in bits
    ...
    public static String generatePassword(String toHash, int hashLength) {
        try {
            ...
            return CURRENT_VERSION + ":" + iterations + ":" + toHex(salt) + ":"
