...
public class OpenNlpTokenExtraction {
    ...
    /**
     * Extract tokens that are words of type nouns, adjectives or forgein words and have length > 1 from a text. NOTE:
     * This method uses pos-tagger and is supposed to be slower than the extractWordTokens()
     *
     * @param text
     * @return
     */
