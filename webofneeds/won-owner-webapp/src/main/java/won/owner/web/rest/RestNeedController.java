...
public class RestNeedController {
     ...
     * 
     * @param createDraftObject
     *            an object containing information of the need draft
    ...
    public ResponseEntity deleteDrafts() {
        try {
             ...
             * draftRepository.findByUserName(user.getUsername()); Iterator<Draft> draftIterator =
             * draftStates.iterator(); List<URI> draftURIs = new ArrayList<>(); while(draftIterator.hasNext()){
