...
@Controller @RequestMapping("/rest/agreement") public class AgreementProtocolController {
  ...
  @RequestMapping(value = "/getAgreementProtocolUris", method = RequestMethod.GET) public ResponseEntity<AgreementProtocolUris> getHighlevelProtocolUris(
      URI connectionUri) {
  ...
  @RequestMapping(value = "/getMessageEffects", method = RequestMethod.GET) public ResponseEntity<Set<MessageEffect>> getMessageEffects(
      URI connectionUri, URI messageUri) {
  ...
  @RequestMapping(value = "/getRetractedUris", method = RequestMethod.GET) public ResponseEntity<Set<URI>> getRetractedUris(
      URI connectionUri) {
    Set<URI> uris = getAgreementProtocolState(connectionUri).getRetractedUris();
    return new ResponseEntity<>(uris, HttpStatus.OK);
  }

  @RequestMapping(value = "/getAgreements", method = RequestMethod.GET) public ResponseEntity<Dataset> getAgreements(
      URI connectionUri) {
  ...
  @RequestMapping(value = "/getAgreementUris", method = RequestMethod.GET) public ResponseEntity<Set<URI>> getAgreementUris(
      URI connectionUri) {
    Set<URI> uris = getAgreementProtocolState(connectionUri).getAgreementUris();
    return new ResponseEntity<>(uris, HttpStatus.OK);
  }

  @RequestMapping(value = "/getAgreement", method = RequestMethod.GET) public ResponseEntity<Model> getAgreement(
      URI connectionUri, String agreementUri) {
  ...
  @RequestMapping(value = "/getPendingProposals", method = RequestMethod.GET) public ResponseEntity<Dataset> getProposals(
      URI connectionUri) {
  ...
  @RequestMapping(value = "/getPendingProposalUris", method = RequestMethod.GET) public ResponseEntity<Set<URI>> getProposalUris(
      URI connectionUri) {
    Set<URI> uris = getAgreementProtocolState(connectionUri).getPendingProposalUris();
    return new ResponseEntity<>(uris, HttpStatus.OK);
  }

  @RequestMapping(value = "/getPendingProposal", method = RequestMethod.GET) public ResponseEntity<Model> getProposal(
      URI connectionUri, String proposalUri) {
  ...
  @RequestMapping(value = "/getCancellationPendingAgreementUris", method = RequestMethod.GET) public ResponseEntity<Set<URI>> getAgreementsProposedToBeCancelledUris(
      URI connectionUri) {
    Set<URI> uris = getAgreementProtocolState(connectionUri).getCancellationPendingAgreementUris();
    return new ResponseEntity<>(uris, HttpStatus.OK);
  }

  @RequestMapping(value = "/getCancelledAgreementUris", method = RequestMethod.GET) public ResponseEntity<Set<URI>> getCancelledAgreementUris(
      URI connectionUri) {
    Set<URI> uris = getAgreementProtocolState(connectionUri).getCancelledAreementUris();
    return new ResponseEntity<>(uris, HttpStatus.OK);
  }

  @RequestMapping(value = "/getRejectedUris", method = RequestMethod.GET) public ResponseEntity<Set<URI>> getRejectedProposalUris(
      URI connectionUri) {
