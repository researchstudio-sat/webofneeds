...
public class WonOwnerMailSender {
  ...
  public void sendConversationNotificationMessage(String toEmail, String localNeed, String remoteNeed,
    ...
    if (textMsg != null && !textMsg.isEmpty()) {
      ...
      logger.warn("do not send notification conversation email to {} with empty message. Connection is: {}", toEmail,
          localConnection);
    }
  }
  ...
  public void sendCloseNotificationMessage(String toEmail, String localNeed, String remoteNeed, String localConnection,
      String textMsg) {
