...
default =
    ...
    , secondaryColorLighter = rgb255 70 140 220
...
decoder =
    Decode.map5 Skin
        ...
        (Decode.field "secondaryColorLighter" colorDecoder)
...
fromFlags flags =
    ...
    , secondaryColorLighter = frgb flags.secondaryColorLighter
