...
import "style/_post-group-messages.scss";
...
export default angular
  .module("won.owner.components.postGroupMessages", [
  ...
  .directive("wonPostGroupMessages", genComponentConf).name;
