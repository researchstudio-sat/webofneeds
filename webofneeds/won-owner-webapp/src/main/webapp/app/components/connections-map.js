...
function genComponentConf() {
  ...
  class Controller {
    constructor() {
      ...
      const selectFromState = state => {
        ...
        const postLocation =
          post &&
          (post.get("is")
            ? post.get("is").get("location")
            : post.get("seeks").get("location"));
    ...
    mapMountNg() {
      return this.domCache.ng(".connections-map__mapmount");
    }
    mapMount() {
      return this.domCache.dom(".connections-map__mapmount");
    }
  }
...
export default angular
  .module("won.owner.components.connectionsMapModule", [inviewModule.name])
  .directive("wonConnectionsMap", genComponentConf).name;
