...
function genComponentConf() {
  ...
  class Controller {
    ...
    input(e) {
      const paragraphsDom = Array.prototype.slice.call(
        // to normal Array
      ...
      const descriptionTags = Immutable.Set(
        description ? description.match(/#(\S+)/gi) : [],
      );
...
export default angular
  .module("won.owner.components.needTextfield", [])
  .directive("needTextfield", genComponentConf).name;
