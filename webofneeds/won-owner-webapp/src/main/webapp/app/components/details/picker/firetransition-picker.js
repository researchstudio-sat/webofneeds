...
import "style/_firetransitionpicker.scss";

const serviceDependencies = ["$scope", "$element"];
function genComponentConf() {
  let template = `
      <div class="firetransitionp__input">
         <svg class="firetransitionp__input__icon clickable"
          ...
          <input
              type="text"
              class="firetransitionp__input__inner"
  ...
  class Controller {
    constructor() {
      ...
      window.firetransitionp4dbg = this;
    ...
    // textfieldNg() {
    //   return this.domCache.ng(".firetransitionp__input__inner");
    // }

    // textfield() {
    //   return this.domCache.dom(".firetransitionp__input__inner");
...
export default angular
  .module("won.owner.components.firetransitionPicker", [wonInput])
  .directive("wonFiretransitionPicker", genComponentConf).name;
