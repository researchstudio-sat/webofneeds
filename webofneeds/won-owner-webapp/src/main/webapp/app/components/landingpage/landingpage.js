...
const workGrid = [{imageSrc: 'generated/icon-sprite.svg#ico36_description', text: 'Post your need anonymously', detail: 'Needs can be very personal, so privacy is important. You don\'t have to reveal your identity here.'},
    {imageSrc: 'generated/icon-sprite.svg#ico36_match', text: 'Your need is automatically matched with other users\'' +
    ' needs', detail: 'Based on the information you provide, we will try to find the best matches for you'},
    {imageSrc: 'generated/icon-sprite.svg#ico36_incoming', text: 'Request Contact', detail: 'If you\'re interested,' +
    ' make a contact request - or get one if your counterpart is faster than you', separatorText: 'or', text2: 'get' +
    ' other users\' contact' +
    ' requests'},
