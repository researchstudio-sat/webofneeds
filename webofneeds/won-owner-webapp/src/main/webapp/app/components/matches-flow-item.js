  ...
  class Controller {
    constructor() {
      ...
      const selectFromState = state => {
        ...
        const remoteNeed =
          connectionData &&
          state.getIn(["needs", connectionData.get("remoteNeedUri")]);

        const hasOptionalFields = !!(
          get(remoteNeed, "location") || get(remoteNeed, "description")
        );
...
export default angular
  .module("won.owner.components.matchesFlowItem", [
    squareImageModule,
  ...
  .directive("wonMatchesFlowItem", genComponentConf).name;
