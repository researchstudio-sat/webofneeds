...
export default class WonConnectionSelectionItem extends React.Component {
  ...
  selectFromState(state) {
    ...
    return {
      ...
      targetAtomFailedToLoad: processUtils.hasAtomFailedToLoad(processState, targetAtomUri),
  ...
  closeConnection() {
    this.props.ngRedux.dispatch(actionCreators.connections__close(this.connectionUri));
