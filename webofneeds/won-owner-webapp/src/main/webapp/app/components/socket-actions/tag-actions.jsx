...
export default function WonTagSocketActions({ connection, goBackOnAction }) {
  ...
  // const deleteButtonElement = (label, dialogText) => (
  //   <button
  //     className="won-button--outlined white"
  //     onClick={() => closeConnection(dialogText)}
  //   >
  //     <svg className="won-button-icon">
  //       <use xlinkHref={ico36_bin} href={ico36_bin} />
  //     </svg>
  //     <span className="won-button-label">{label}</span>
  //   </button>
  // );
  ...
  switch (connectionState) {
    ...
    default:
      return <won-tag-socket-actions>Unknown State</won-tag-socket-actions>;
  }
}
WonTagSocketActions.propTypes = {
