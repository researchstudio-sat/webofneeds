...
/*
OLD PROPS AND STUFF WAS CALCULATED THE FOLLOWING WAY:
const buddies = hasBuddySocket && get(atom, "buddies");
const hasBuddies = buddies && buddies.size > 0;
  const hasBuddyConnections = buddyConnections && buddyConnections.size > 0;
  const buddyConnectionsArray = buddyConnections && buddyConnections.toArray();

  const buddiesArray = buddies && buddies.toArray();
...
const buddyConnections =
  ...
  let excludedFromRequestUris = [atomUri];
