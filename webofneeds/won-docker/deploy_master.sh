...
ssh won@satvm02 mkdir -p $base_folder/custom_owner_skin_blue
ssh won@satvm02 mkdir -p $base_folder/custom_owner_skin_green
scp -r $WORKSPACE/webofneeds/won-owner-webapp/src/main/webapp/skin/blue/* won@satvm02:$base_folder/custom_owner_skin_blue/
scp -r $WORKSPACE/webofneeds/won-owner-webapp/src/main/webapp/skin/green/* won@satvm02:$base_folder/custom_owner_skin_green/
