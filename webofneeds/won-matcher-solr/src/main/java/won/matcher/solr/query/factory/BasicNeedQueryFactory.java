...
public class BasicNeedQueryFactory extends NeedDatasetQueryFactory {
  ...
  static {
    ...
    descriptionFieldMap.put(MatcherNeedContentPropertyType.IS, "_graph.http___purl.org_dc_elements_1.1_description");
  ...
  public void addLocationFilters(Resource contentNode, MatcherNeedContentPropertyType fieldType) {
    ...
    if (coordinate != null) {
      locationFactories.add(new GeoDistBoostQueryFactory(locationFieldMap.get(fieldType), coordinate.getLatitude(),
