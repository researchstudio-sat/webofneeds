...
/**
 * Interface camel actor that is used to listen at the WoN node for events about
 * new created needs, activated needs and deactivated needs. Depending on the endpoint it
