...
/**
 * Camel actor represents the need consumer protocol to a won node. It is used to listen at the WoN node for events
 * about new created needs, activated needs and deactivated needs. Depending on the endpoint it might be used with
