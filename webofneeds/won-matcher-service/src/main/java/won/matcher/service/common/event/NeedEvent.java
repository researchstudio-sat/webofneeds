...
/**
 * This event is used in the matching service to indicate that a new need has been found. It includes the URIs of the
 * need and the won node and optionally the serialized resource
 *
