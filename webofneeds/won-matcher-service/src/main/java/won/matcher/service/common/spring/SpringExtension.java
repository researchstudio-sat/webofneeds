...
public class SpringExtension extends AbstractExtensionId<SpringExtension.SpringExt> {
    ...
    public static class SpringExt implements Extension {
        ...
        /**
         * Create a Props for the specified actorClass using the SpringActorProducer class.
         *
         * @param actorClass
         *            class of an actor
        ...
        /**
         * Create a Props for the specified actorClass and additional parameters using the SpringActorProducer class.
         *
         * @param actorClass
         *            class of an actor
         * @param params
         *            additional parameters for actor creation
         * @return a Props that will create the named actor bean using Spring
         */
        ...
        /**
         * Create Props from the configuration file for the specified actorClass using the SpringActorProducer class.
         *
         * @param actorClass
         *            class of an actor
         * @return a Props that will create the named actor bean using Spring
