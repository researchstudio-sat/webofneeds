...
/**
 * Factory for creating a {@link won.matcher.service.nodemanager.pojo.WonNodeConnection} with ActiveMq endpoint of a won
 * node
 * <p>
...
public class ActiveMqWonNodeConnectionFactory {
     ...
     *
     * @param context
     *            actor context to create the message consuming actors in
     * @param wonNodeInfo
     *            info about the won node (e.g. topics to subscribe)
    ...
    private static ActiveMQConnectionFactory createConnectionFactory(final String brokerUri,
        ...
        // for non-persistent messages setting "AlwaysSyncSend" to true makes it slow, but ensures that a producer is
