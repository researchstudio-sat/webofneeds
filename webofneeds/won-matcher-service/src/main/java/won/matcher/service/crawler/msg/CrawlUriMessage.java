...
public class CrawlUriMessage implements Serializable {
    public static enum STATUS {
        PROCESS, // resource is currently in the crawling process (e.g. downloading, link extraction, saving to rdf
                 // store)
    ...
    /**
     * @param uri
     *            URI that should be or is already crawled
     * @param baseUri
     *            base URI that is used with property paths to extract further URIs
     * @param wonNodeUri
     *            URI of the corresponding won node
     * @param status
     *            describes what to with the URI
     * @param crawlDate
     *            timestamp in milli seconds when crawling message was generated
     * @param etags
     *            last known Etag header values for the resource
     */
