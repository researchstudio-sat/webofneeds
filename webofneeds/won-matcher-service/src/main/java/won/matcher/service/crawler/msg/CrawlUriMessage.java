...
public class CrawlUriMessage implements Serializable {
   ...
   * @param baseUri    base URI that is used with property paths to extract
   *                   further URIs
  ...
  public String toString() {
    String etags = getResourceETagHeaderValues() != null ? String.join(", ", getResourceETagHeaderValues()) : "<None>";
