...
/**
 * JUnit tests to check the WoN ontology against the competency questions. One test case for each question.
 *
...
public class Validator {
    ...
    public void testCQWhat4() {
        ...
        String queryString = sparqlPreface + "SELECT ?need ?height ?heightV ?heightM ?width ?widthV ?widthM "
                ...
                + "?height gr:hasUnitOfMeasurement ?heightM." + "?content won:hasWidth ?width."
                + "?width gr:hasValue ?widthV." + "?width gr:hasUnitOfMeasurement ?widthM."
                + "?content won:hasDepth ?depth." + "?depth gr:hasValue ?depthV."
    ...
    public void testCQWhere1() {
        ...
        String expected3 = "( ?need = <" + EXAMPLE_ONTOLOGY_URI + "Need_01> ) " + "( ?needModality = <"
                ...
                + "Österreich> ) " + "( ?p = <" + WON_ONTOLOGY_URI + "hasISOCode> ) ( ?o = \"AT\"^^xsd:string )";
