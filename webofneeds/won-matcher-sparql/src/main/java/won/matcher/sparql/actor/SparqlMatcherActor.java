...
import won.matcher.sparql.hints.HintBuilder;
import won.matcher.sparql.index.NeedIndexer;
import won.matcher.sparql.query.DefaultMatcherQueryExecuter;
import won.matcher.sparql.query.SparqlMatcherQueryExecutor;
import won.matcher.sparql.query.TestMatcherQueryExecutor;
import won.matcher.sparql.query.factory.*;
...
public class SparqlMatcherActor extends UntypedActor {
    ...
    protected void processActiveNeedEvent(NeedEvent needEvent)
        ...
        SparqlMatcherQueryExecutor queryExecutor = (usedForTesting ? testQueryExecuter : defaultQueryExecuter);
