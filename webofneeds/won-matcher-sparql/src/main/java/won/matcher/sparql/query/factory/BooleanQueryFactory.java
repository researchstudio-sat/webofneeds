 ...
 */
public class BooleanQueryFactory extends SparqlQueryFactory {
    private SparqlQueryFactory[] factories;
    ...
    public BooleanQueryFactory(BooleanOperator op, SparqlQueryFactory... factories) {
        operator = op;
