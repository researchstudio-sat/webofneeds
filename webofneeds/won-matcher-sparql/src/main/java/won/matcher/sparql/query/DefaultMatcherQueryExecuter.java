...
import won.matcher.sparql.query.factory.MatchingContextQueryFactory;
 ...
 */
@Component
public class DefaultMatcherQueryExecuter implements SparqlMatcherQueryExecutor {
    private final Logger log = LoggerFactory.getLogger(getClass());

    @Autowired
    SparqlMatcherConfig config;
