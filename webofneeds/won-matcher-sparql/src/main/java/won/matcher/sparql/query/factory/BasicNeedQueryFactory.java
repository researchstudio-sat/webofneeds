...
public class BasicNeedQueryFactory extends NeedDatasetQueryFactory {
    ...
    protected ArrayList<SparqlQueryFactory> contentFactories;
    protected ArrayList<SparqlQueryFactory> locationFactories;
    ...
    public void addTermsToTitleQuery(String terms, NeedContentPropertyType fieldType, double boost) {
        ...
        if (terms != null && !terms.trim().isEmpty()) {
            ...
            SparqlQueryFactory qf = new MatchFieldQueryFactory(field, terms);
            qf.setBoost(boost);
    ...
    protected String makeQueryString() {
        ...
        if (locationFactories.size() > 0) {
            ...
            sb.append("sum(1");
            for (SparqlQueryFactory queryFactory : locationFactories) {
        ...
        SparqlQueryFactory[] contentArray = new SparqlQueryFactory[contentFactories.size()];
