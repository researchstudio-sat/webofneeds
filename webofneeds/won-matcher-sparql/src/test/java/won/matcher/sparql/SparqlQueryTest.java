...
public class SparqlQueryTest {
    ...
    public void testAddGraphOp() throws Exception {
        ...
        Assert.assertEquals("Adding graph op to query did not yield expected result", expectedQueryWithGraphClause,
    ...
    /**
     * Test that reads a query from a file and repeatedly runs noHintForCounterpartQuery and hintForCounterpartQuery
     * from SparqlMatcherUtils, checking that the desired result is obtained each time, i.e., the methods have no side
     * effects.
     */
    @Test
    public void testAddRequiredFlag_NoHintForCounterpart_Nosideeffects() throws Exception {
        ...
        String queryStringNoHintForCounterpartExpected = getResourceAsString(
                "sparqlquerytest/no-hint-for-counterpart/expected.rq");
    ...
    public void testAddRequiredFlag_NoHintForCounterpart() throws Exception {
        ...
        Var resultName = Var.alloc("result");
        Var scoreName = Var.alloc("score");
        checkResult(queryString, expectedQueryString,
                op -> SparqlMatcherUtils.noHintForCounterpartQuery(op, resultName));
    }
    ...
    private void checkResult(String queryString, String expectedQueryString, Function<Op, Op> transform) {
        ...
        String expected = OpAsQuery.asQuery(expectedOp).toString();
        /*
         * System.out.println("expected:"); System.out.println(expectedOp); System.out.println(expected);
         * System.out.println("actual:"); System.out.println(actualOp); System.out.println(actual);
         */
        Assert.assertEquals(expected, actual);
    }
}
