package won.matcher.sparql.evaluation;
...
import won.matcher.sparql.query.factory.BasicNeedQueryFactory;
import won.matcher.sparql.query.factory.TestNeedQueryFactory;
 ...
 */
@Component
public class SparqlMatcherEvaluation
{
  @Autowired
  ...
  public SparqlMatcherEvaluation() {
