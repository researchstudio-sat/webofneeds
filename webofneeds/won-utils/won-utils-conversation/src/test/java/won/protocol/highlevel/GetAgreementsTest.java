...
public class GetAgreementsTest {
    ...
    /*
     * @Test public void twoProposalTwoAgreementsOneCancellation () throws IOException { Dataset input = loadDataset(
     * inputFolder + "2proposal-2agreements-onecancellation.trig"); Dataset expectedOutput = loadDataset(
     * expectedOutputFolder + "2proposal-2agreements-onecancellation.trig"); test(input,expectedOutput); }
     */
