...
/**
 * Class describes the outcome of a goal instantiation attempt. Instance model represents the extracted instance data.
 * Shacl shapes model describes the shapes model that is evaluated against the instance model. And Shacl report wrapper
 * describes the shacl report outcome from the shacl evaluation.
 */
public class GoalInstantiationResult {
     ...
     *
     * @return true if, there are no shacl validation errors in the evaluation of the instance model against the shacl
     *         shapes model. False otherwise.
     */
