...
public class VisitorClassTypeSpecs extends ProducerConsumerMap<URI, Set<TypeSpec>>
                implements UpdateableTypeSpecMapping {
    @Override
    ...
    public VisitorClassTypeSpecs.Producer producer() {
        return new VisitorClassTypeSpecs.Producer();
    }
